...
window.klaroConfig = {
  ...
  "uuid": "9393cb2b-b46a-466d-a2c6-68c7a21ea41e",
  ...
  "translations": {
    ...
    "ks": {
      ...
      "purposes": {
        ...
        "Marketing": {
          "description": "یم کوکیز چھ سٲنۍ تشہیری شراکت دار ذاتی اشتہار فراہم کرنہٕ تہٕ مارکیٹنگ مہمن ہنٛد اثر و رسوخچ پیمٲئش کرنہٕ خٲطرٕ استعمال کران۔ تم چھ صارفن ہنٛز دلچسپین تہٕ براؤزنگ رویس پیٹھ مبنی متعلقہ پروموشنز فراہم کرنس منٛز مدد کران۔"
        }
      },
      "service": {
        "disableAll": {
    ...
    "as": {
      ...
      "ok": "সকলো গ্ৰহণ কৰক",
      "consentNotice": {
        "description": "আমি আপোনাৰ গোপনীয়তাক সন্মান কৰোঁ-ষ্টাৰ হেল্থ ডেমো উদ্দেশ্যৰ বাবে আমি অত্যাৱশ্যকীয় ছাইট কাৰ্য্যকৰীতা, লগতে বিপণন, ব্যক্তিগতকৰণ আৰু বিশ্লেষণ সক্ষম কৰিবলৈ কুকিজ সংৰক্ষণ কৰোঁ। \"সকলো গ্ৰহণ কৰক\" ক্লিক কৰি, আপুনি আমাৰ কুকিজৰ ব্যৱহাৰত সন্মতি প্ৰদান কৰে। আপুনি যিকোনো সময়তে আপোনাৰ ছেটিংছ সলনি কৰিব পাৰে। কুকি নীতি।",
        "learnMore": "স্বনিৰ্বাচিত কৰক",
        "changeDescription": " "
      },
      "save": "গ্ৰহণ কৰক",
      "consentModal": {
        "title": "সন্মতিৰ অগ্ৰাধিকাৰসমূহ স্বনিৰ্ধাৰণ কৰক-কেৱল ষ্টাৰ হেল্থ টেণ্টত অভাৰলে অপ্ট কৰক",
    ...
    "mai": {
      ...
      "save": "स्वीकार करू",
      "consentModal": {
        "title": "सहमति वरीयता केँ अनुकूलित करू-केवल स्टार हेल्थ किरायेदार मे ओवरले विकल्प",
      ...
      "purposes": {
        "Others": {
          "description": "एहि श्रेणीमे कुकीज सम्मिलित अछि जे पूर्वनिर्धारित श्रेणीमे फिट नहि होइत अछि मुदा वेबसाइटक किछु कार्यात्मकता वा सुधारक लेल आवश्यक भऽ सकैत अछि।"
        },
        "Functional": {
    ...
    "sd": {
      ...
      "save": "قبول ڪریو",
      "consentModal": {
        "title": "رضامندی جی ترجیحن کی حسب ضرورت ٺاہیو-صرف اسٽار صحت جی ڪرائی تی ڏیڻ واری چونڊ ۾",
    ...
    "gom": {
      ...
      "ok": "सगळें मान्य कर",
      "consentNotice": {
        "description": "आमी तुमच्या गुप्ततायेचो आदर करतात-स्टार हेल्थ डेमो हेतुके खातीर आमी गरजेचीं सायट कार्यक्षमताय, तशेंच मार्केटींग, वैयक्तीकरण आनी विश्लेशण सक्षम करपा खातीर कुकीज सांठोवन दवरतात. \"सगळे मान्य करात\" क्लिकेल्यार, तुमी आमचे कुकीज वापरपाक मान्यताय दितात. तुमी खंयच्याय वेळार तुमची सेटिंग बदलूंक शकतात. कुकी धोरण.",
      ...
      "purposes": {
        ...
        "Marketing": {
          "description": "हे कुकीज आमचे जायरात भागीदार वैयक्तीक जायराती दिवपा खातीर आनी मार्केटींग मोहिमांची परिणामकारकता मेजपा खातीर वापरतात. वापरप्याची आवड आनी ब्राउझिंग वेव्हाराचेर आदारून संबंदीत बडटी दिवपाक ते मदत करतात."
        }
      },
      "service": {
        "disableAll": {
