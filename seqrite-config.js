...
window.klaroConfig = {
  ...
  "uuid": "269118d9-30fc-4faa-a9f0-e10115ea61ba",
  ...
  "translations": {
    "english": {
      ...
      "save": "Accept",
      "consentModal": {
        "title": "<p>Customize Consent Preferences - 27th Jan 2026</p>",
    ...
    "ks": {
      ...
      "save": "قبول کرن۔",
      "consentModal": {
        "title": "رضامندی ہنز ترجیحات کسٹمائز کریو-27 جنوری 2026",
    ...
    "doi": {
      ...
      "save": "मंजूर करो",
      "consentModal": {
        "title": "सहमति वरीयताएं गी अनुकूलित करो-27 जनवरी 2026",
    ...
    "ml": {
      ...
      "save": "സ്വീകരിക്കുക",
      "consentModal": {
        "title": "സമ്മത മുൻഗണനകൾ ഇഷ്ടാനുസൃതമാക്കുക-2026 ജനുവരി 27",
    ...
    "mni": {
      ...
      "save": "ꯂꯧꯁꯤꯟꯕꯤꯌꯨ",
      "consentModal": {
        "title": "ꯀꯟꯁꯦꯟꯠ ꯄ ꯭ ꯔꯦꯐꯔꯦꯟꯁꯁꯤꯡ ꯀꯁ ꯭ ꯇꯥꯃꯥꯏꯖ ꯇꯧ-ꯖꯅꯨꯋꯥꯔꯤ 27,2026",
    ...
    "sat": {
      ...
      "save": "ᱦᱟᱛᱟᱣ ᱢᱮ ᱾",
      "consentModal": {
        "title": "ᱥᱳᱯᱨᱩᱢᱟᱱᱟᱜ ᱵᱟᱪᱷᱱᱟᱣ ᱠᱚ ᱜᱚᱴᱟᱼᱵᱩᱴᱟᱹ ᱢᱮᱼ27 ᱡᱟᱱᱩᱭᱨᱤ 2026",
    ...
    "ur": {
      ...
      "save": "قبول کریں۔",
      "consentModal": {
        "title": "رضامندی کی ترجیحات کو حسب ضرورت بنائیں-27 جنوری 2026",
    ...
    "brx": {
      ...
      "save": "नाजाव",
      "consentModal": {
        "title": "गनायथि सायख 'नायफोरखौ कास्टमाइज खालाम-27थि जानुआरि 2026",
    ...
    "mr": {
      ...
      "save": "स्वीकारा",
      "consentModal": {
        "title": "संमतीची प्राधान्ये सानुकूलित करा-27 जानेवारी 2026",
    ...
    "or": {
      ...
      "save": "ଗ୍ରହଣ କରନ୍ତୁ",
      "consentModal": {
        "title": "ସମ୍ମତି ପସନ୍ଦକୁ ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ-27 ଜାନୁଆରୀ 2026",
    ...
    "as": {
      ...
      "save": "গ্ৰহণ কৰক",
      "consentModal": {
        "title": "সন্মতিৰ অগ্ৰাধিকাৰসমূহ অনুকূলিত কৰক-27 জানুৱাৰী 2026",
    ...
    "mai": {
      ...
      "save": "स्वीकार करू",
      "consentModal": {
        "title": "सहमति वरीयता अनुकूलित करू-27 जनवरी 2026",
    ...
    "ta": {
      ...
      "save": "ஏற்றுக்கொள்",
      "consentModal": {
        "title": "சம்மத விருப்பங்களைத் தனிப்பயனாக்குங்கள்-27 ஜனவரி 2026",
    ...
    "sd": {
      ...
      "save": "قبول ڪریو",
      "consentModal": {
        "title": "رضامندی جی ترجیحن کی ترتیب ڏیو-27 جنوری 2026",
    ...
    "bn": {
      ...
      "save": "গ্রহণ করুন",
      "consentModal": {
        "title": "সম্মতি পছন্দগুলি কাস্টমাইজ করুন-27শে জানুয়ারী 2026",
    ...
    "te": {
      ...
      "save": "అంగీకరించండి",
      "consentModal": {
        "title": "సమ్మతి ప్రాధాన్యతలను అనుకూలీకరించండి-27 జనవరి 2026",
    ...
    "gu": {
      ...
      "save": "સ્વીકારો",
      "consentModal": {
        "title": "સંમતિ પસંદગીઓને કસ્ટમાઇઝ કરો-27મી જાન્યુઆરી 2026",
    ...
    "kn": {
      ...
      "save": "ಸ್ವೀಕರಿಸಿ",
      "consentModal": {
        "title": "ಒಪ್ಪಿಗೆಯ ಆದ್ಯತೆಗಳನ್ನು ಕಸ್ಟಮೈಸ್ ಮಾಡಿ-27 ಜನವರಿ 2026",
    ...
    "ne": {
      ...
      "consentModal": {
        "title": "सहमति प्राथमिकताहरू अनुकूलित गर्नुहोस्-27 जनवरी 2026",
    ...
    "hi": {
      ...
      "save": "स्वीकार करें",
      "consentModal": {
        "title": "सहमति वरीयताओं को अनुकूलित करें-27 जनवरी 2026",
    ...
    "gom": {
      ...
      "save": "स्विकार कर",
      "consentModal": {
        "title": "संमतीची पसंती सानुकूल करात-27 जानेवारी 2026",
    ...
    "pa": {
      ...
      "save": "ਸਵੀਕਾਰ ਕਰੋ",
      "consentModal": {
        "title": "ਸਹਿਮਤੀ ਤਰਜੀਹਾਂ ਨੂੰ ਅਨੁਕੂਲਿਤ ਕਰੋ-27 ਜਨਵਰੀ 2026",
    ...
    "sa": {
      ...
      "save": "स्वीकरोतु",
      "consentModal": {
        "title": "सहमतिप्राधान्यतां स्वकीयीकरोतु-27 जनवरी 2026",
