...
window.klaroConfig = {
  ...
  "uuid": "1409441d-81b7-4d96-b202-f8c35076e124",
  ...
  "translations": {
    "english": {
      ...
      "ok": "Accept All",
      "consentNotice": {
        "description": "<p><strong>We respect your privacy - Banner &gt; Ovelay, Opt in and Indian ans GT Languages</strong></p><p><strong>We store cookies to enable essential site functionality, as well as marketing, personalization and analytics. By clicking “Accept All”, you consent to our use of cookies. You can change your settings at any time. </strong><a href=\"https://www.google.com/\" title=\"https://www.google.com/\" target=\"_blank\"><strong><u>Cookie Policy.</u></strong></a></p>",
        "learnMore": "Customize",
        "changeDescription": " "
      },
      "save": "Accept",
      "consentModal": {
        "title": "<p>Customize Consent Preferences - <strong>Banner &gt; Ovelay, Opt in and Indian ans GT Languages</strong></p>",
    ...
    "ks": {
      ...
      "ok": "سٲری کر قبوٗل۔",
      "consentNotice": {
        "description": "أسۍ چھ تہنٛز راز دٲری ہنٛد احترام کران-بینر> اوولی، آپٹ ان تہٕ ہندوستٲنی تہٕ جی ٹی زبانہٕ أسۍ چھ ضروری سایٹہ ہنٛز فعالیتس سۭتۍ سۭتۍ مارکیٹنگ، پرسنلائزیشن تہٕ تجزیاتن فعال کرنہٕ خٲطرٕ کوکیز ذخیرٕ کران۔ \"تمام قبول کرو\" کلک کرتھ، تہۍ چھو سانۍ کوکیز استعمال کرنہٕ خٲطرٕ رضامند۔ تہۍ ہیٚکو کنہ تہ وقتہٕ پنٕنۍ سیٹنگہٕ تبدیل کٔرتھ۔ کوکی پالیسی۔",
        "learnMore": "کسٹمائز کر۔",
        "changeDescription": " "
      },
      "save": "قبول کرن۔",
      "consentModal": {
        "title": "رضامندی ہنز ترجیحات کر کسٹمائز-بینر> اوولے، آپٹ ان تہٕ ہندوستٲنی تہٕ جی ٹی زبانہٕ",
    ...
    "ml": {
      ...
      "consentNotice": {
        "description": "നിങ്ങളുടെ സ്വകാര്യതയെ ഞങ്ങൾ മാനിക്കുന്നു-ബാനർ> ഒവ്ലേ, ഒപ്റ്റ് ഇൻ, ഇന്ത്യൻ ആൻസ് ജിടി ഭാഷകൾ അവശ്യ സൈറ്റ് പ്രവർത്തനക്ഷമത, മാർക്കറ്റിംഗ്, വ്യക്തിഗതമാക്കൽ, വിശകലനം എന്നിവ പ്രാപ്തമാക്കുന്നതിന് ഞങ്ങൾ കുക്കികൾ സംഭരിക്കുന്നു. \"എല്ലാം സ്വീകരിക്കുക\" ക്ലിക്കുചെയ്യുന്നതിലൂടെ, ഞങ്ങളുടെ കുക്കികളുടെ ഉപയോഗത്തിന് നിങ്ങൾ സമ്മതിക്കുന്നു. നിങ്ങൾക്ക് എപ്പോൾ വേണമെങ്കിലും നിങ്ങളുടെ ക്രമീകരണങ്ങൾ മാറ്റാം. കുക്കി നയം.",
        "learnMore": "ഇഷ്ടാനുസൃതമാക്കുക",
        "changeDescription": " "
      },
      "save": "സ്വീകരിക്കുക",
      "consentModal": {
        "title": "സമ്മത മുൻഗണനകൾ ഇഷ്ടാനുസൃതമാക്കുക-ബാനർ> ഒവ്ലേ, തിരഞ്ഞെടുക്കുക, ഇന്ത്യൻ ആൻസ് ജിടി ഭാഷകൾ",
    ...
    "mni": {
      ...
      "ok": "ꯄꯨꯝꯅꯃꯛ ꯂꯧꯕꯤꯌꯨ",
      "consentNotice": {
        "description": "ꯑꯩꯈꯣꯏꯅ ꯅꯍꯥꯛꯀꯤ ꯂꯟꯅꯥꯏꯕꯨ ꯏꯀꯥꯏꯈꯨꯝꯅꯩ-ꯕꯦꯅꯔ> ꯑꯣꯚꯦꯂꯦ, ꯑꯣꯞꯠ ꯏꯟ ꯑꯃꯁꯨꯡ ꯏꯟꯗꯤꯌꯟ ꯑꯦꯟꯁ ꯖꯤ. ꯇꯤ. ꯂꯡꯒ ꯭ ꯋꯦꯖꯁ ꯑꯩꯈꯣꯏꯅ ꯇꯉꯥꯏꯐꯗꯕ ꯁꯥꯏꯠꯀꯤ ꯃꯊꯧ ꯇꯧꯕ ꯉꯝꯕ, ꯃꯥꯔꯀꯦꯇꯤꯡ, ꯄꯦꯁ ꯭ ꯅꯦꯜꯥꯏꯖꯦꯁꯟ ꯑꯃꯁꯨꯡ ꯑꯦꯅꯥꯂꯤꯇꯤꯛꯁ ꯇꯧꯕ ꯉꯝꯅꯕ ꯀꯨꯀꯤꯁꯤꯡ ꯊꯝꯃꯤ ꯫ \"ꯄꯨꯝꯅꯃꯛ ꯌꯥꯕꯤꯌꯨ\" ꯍꯥꯏꯕ ꯑꯗꯨꯗ ꯅꯝꯗꯨꯅ, ꯅꯍꯥꯛꯅ ꯑꯩꯈꯣꯏꯒꯤ ꯀꯨꯀꯤꯁꯤꯡ ꯁꯤꯖꯤꯟꯅꯕ ꯌꯥꯔꯦ ꯫ ꯅꯍꯥꯛꯅ ꯃꯇꯝ ꯑꯃꯍꯦꯛꯇꯗ ꯅꯍꯥꯛꯀꯤ ꯁꯦꯇꯤꯡꯁ ꯑꯗꯨ ꯍꯣꯡꯗꯣꯛꯄ ꯌꯥꯏ ꯫ ꯀꯨꯀꯤꯒꯤ ꯊꯧꯁꯤꯜ ꯫",
        "learnMore": "ꯀꯁꯇꯃꯥꯏꯖ ꯇꯧ ꯫",
        "changeDescription": " "
      },
      "save": "ꯂꯧꯁꯤꯟꯕꯤꯌꯨ",
      "consentModal": {
        "title": "ꯀꯁ ꯭ ꯇꯥꯃꯥꯏꯖ ꯀꯟꯁꯦꯟꯠ ꯄ ꯭ ꯔꯦꯐꯔꯦꯟꯁ-ꯕꯦꯅꯔ> ꯑꯣꯚꯦꯂꯦ, ꯑꯣꯞꯠ ꯏꯟ ꯑꯃꯁꯨꯡ ꯏꯟꯗꯤꯌꯟ ꯑꯦꯟꯁ ꯖꯤ. ꯇꯤ. ꯂꯡꯒ ꯭ ꯋꯦꯖꯁ",
    ...
    "sat": {
      ...
      "consentNotice": {
        "description": "ᱟᱢ ᱟᱢᱟᱜ ᱜᱚᱭᱱᱟᱥᱤᱼᱵᱮᱱᱟᱨ> ᱚᱵᱷᱮᱞᱮ, ᱚᱯᱴ ᱤᱱ ᱟᱨ ᱵᱷᱟᱨᱚᱛᱤᱭᱚ ᱟᱨ ᱡᱤᱴᱤ ᱯᱟᱹᱨᱥᱤ ᱠᱚ ᱢᱟᱹᱱ ᱮᱫᱟ, ᱡᱟᱦᱟᱸ ᱫᱚ ᱟᱢ ᱟᱹᱰᱤ ᱞᱟᱹᱠᱛᱤ ᱥᱟᱭᱤᱴ ᱨᱮᱭᱟᱜ ᱠᱟᱹᱢᱤ ᱫᱟᱲᱮᱹᱣᱟᱱᱟᱜ ᱥᱟᱶ ᱥᱟᱶᱛᱮ ᱵᱤᱪᱷᱱᱟᱶ, ᱯᱮᱥᱚᱱᱮᱞᱟᱭᱮᱥᱚᱱ ᱟᱨ ᱚᱱᱚᱞᱤᱠᱤᱥ ᱠᱚᱨᱟᱣ ᱞᱟᱹᱜᱤᱫ ᱠᱩᱠᱤ ᱠᱚ ᱫᱚᱦᱚ ᱮᱫᱟ ᱾ \"ᱥᱟᱱᱟᱢᱟᱜ ᱦᱟᱛᱟᱣ ᱢᱮ\" ᱨᱮ ᱠᱞᱤᱠ ᱠᱟᱛᱮ, ᱟᱢ ᱤᱧᱟᱹᱜ ᱠᱩᱠᱤᱠᱚ ᱵᱮᱶᱦᱟᱨ ᱞᱟᱹᱜᱤᱫ ᱮ ᱥᱤᱜᱤᱞ ᱞᱮᱱᱟ ᱾ ᱟᱢ ᱡᱟᱦᱟᱸ ᱚᱠᱛᱚ ᱨᱮᱦᱚᱸ ᱟᱢᱟᱜ ᱥᱮᱴᱤᱝ ᱠᱚ ᱵᱚᱱᱚᱫᱚᱞ ᱫᱟᱲᱮᱭᱟᱜᱼᱟ ᱾ ᱠᱩᱠᱤ ᱟᱹᱨᱤ ᱾",
        "learnMore": "ᱠᱟᱥᱴᱚᱢᱟᱭᱤᱡ ᱢᱮ ᱾",
        "changeDescription": " "
      },
      "save": "ᱦᱟᱛᱟᱣ ᱢᱮ ᱾",
      "consentModal": {
        "title": "ᱥᱳᱯᱨᱳᱫᱽ ᱨᱮ ᱥᱚᱨᱮᱥᱟᱱ ᱠᱚ ᱠᱟᱥᱴᱚᱢᱟᱭᱤᱡᱽ ᱢᱮᱼᱵᱮᱱᱟᱨ> ᱚᱵᱷᱮᱞᱮ, ᱚᱯᱴ ᱤᱱ ᱟᱨ ᱵᱷᱟᱨᱚᱛᱤᱭᱚ ᱟᱨ ᱡᱤᱴᱤ ᱯᱟᱹᱨᱥᱤ ᱾",
    ...
    "ur": {
      ...
      "ok": "سب کو قبول کریں",
      "consentNotice": {
        "description": "ہم آپ کی پرائیویسی کا احترام کرتے ہیں-بینر> اوولی، آپٹ ان اور ہندوستانی اور جی ٹی زبانیں ہم سائٹ کی ضروری فعالیت کے ساتھ مارکیٹنگ، شخصی کاری اور تجزیات کو فعال کرنے کے لیے کوکیز کو اسٹور کرتے ہیں۔ \"سب کو قبول کریں\" پر کلک کرکے، آپ ہمارے کوکیز کے استعمال سے اتفاق کرتے ہیں۔ آپ کسی بھی وقت اپنی ترتیبات تبدیل کر سکتے ہیں۔ کوکی پالیسی۔",
        "learnMore": "اپنی مرضی کے مطابق بنائیں",
        "changeDescription": " "
      },
      "save": "قبول کریں۔",
      "consentModal": {
        "title": "رضامندی کی ترجیحات کو حسب ضرورت بنائیں-بینر> اوولے، آپٹ ان اور ہندوستانی اور جی ٹی زبانیں",
    ...
    "brx": {
      ...
      "ok": "गासिबो नाजाव",
      "consentNotice": {
        "description": "जों नोंनि प्राइभेसिखौ मान होयो-बेनार> अभेले, अप्ट इन आरो भारतारि आरो जि. टि. रावफोर जों गोनांथार साइटनि खामानिजों लोगोसे मार्केटिं, गावारि खालामनाय आरो एनालाइटिक्स खालामनो थाखाय कुकिफोरखौ दोनथुमो। \"गासिबो नाजाव\" आव क्लिक खालामनानै, नों जोंनि कुकिफोरनि बाहायनायखौ गनायो। नोंथाङा जायखिजाया समावनो गावनि सेटिंसखौ सोलायनो हायो। कुकि पलिसि।",
        "learnMore": "कास्टमाइज खालाम",
        "changeDescription": " "
      },
      "save": "नाजाव",
      "consentModal": {
        "title": "गनायथि सायख 'नायफोरखौ कास्टमाइज खालाम-बेनार> अभेले, सायख' आरो भारतारि आरो जी. टी. रावफोर",
    ...
    "mr": {
      ...
      "ok": "सर्व स्वीकारा",
      "consentNotice": {
        "description": "आम्ही तुमच्या गोपनीयतेचा आदर करतो-बॅनर> ओवले, निवड आणि भारतीय आणि जी. टी. भाषा आम्ही आवश्यक साइट कार्यक्षमता, तसेच विपणन, वैयक्तिकरण आणि विश्लेषण सक्षम करण्यासाठी कुकीज संचयित करतो. \"सर्व स्वीकारा\" वर क्लिक करून, तुम्ही आमच्या कुकीजच्या वापरासंमती देता. तुम्ही कधीही तुमचे सेटिंग बदलू शकता. कुकी धोरण.",
        "learnMore": "सानुकूलित करा",
        "changeDescription": " "
      },
      "save": "स्वीकारा",
      "consentModal": {
        "title": "संमतीची प्राधान्ये सानुकूलित करा-बॅनर> ओवले, निवडा आणि भारतीय आणि जी. टी. भाषा",
    ...
    "or": {
      ...
      "consentNotice": {
        "description": "ଆମେ ଆପଣଙ୍କ ଗୋପନୀୟତାକୁ ସମ୍ମାନ କରୁ-ବ୍ୟାନର> ଓଭଲେ, ଅପ୍ଟ ଇନ୍ ଏବଂ ଭାରତୀୟ ଏବଂ ଜି. ଟି. ଭାଷାଗୁଡ଼ିକ ଅତ୍ୟାବଶ୍ୟକ ସାଇଟ୍ କାର୍ଯ୍ୟକାରିତା ସହିତ ମାର୍କେଟିଂ, ବ୍ୟକ୍ତିଗତକରଣ ଏବଂ ବିଶ୍ଳେଷଣକୁ ସକ୍ଷମ କରିବା ପାଇଁ ଆମେ କୁକିଜ୍ ଷ୍ଟୋର୍ କରୁ। \"ସମସ୍ତଙ୍କୁ ଗ୍ରହଣ କରନ୍ତୁ\" ଉପରେ କ୍ଲିକ୍ କରି, ଆପଣ ଆମର କୁକିଜ୍ ବ୍ୟବହାର ପାଇଁ ରାଜି ହୁଅନ୍ତି। ଆପଣ ଯେକୌଣସି ସମୟରେ ନିଜର ସେଟିଂ ବଦଳାଇ ପାରିବେ। କୁକି ନୀତି।",
        "learnMore": "ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ",
        "changeDescription": " "
      },
      "save": "ଗ୍ରହଣ କରନ୍ତୁ",
      "consentModal": {
        "title": "ସମ୍ମତି ପସନ୍ଦଗୁଡ଼ିକୁ ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ-ବ୍ୟାନର> ଓଭଲେ, ଚୟନ କରନ୍ତୁ ଏବଂ ଭାରତୀୟ ଏବଂ ଜି. ଟି. ଭାଷାଗୁଡ଼ିକ",
    ...
    "as": {
      ...
      "ok": "সকলো গ্ৰহণ কৰক",
      "consentNotice": {
        "description": "আমি আপোনাৰ গোপনীয়তাক সন্মান কৰোঁ-বেনাৰ> অ 'ভেলে, অপ্ট ইন আৰু ভাৰতীয় আৰু জিটি ভাষাসমূহ আমি অত্যাৱশ্যকীয় ছাইট কাৰ্য্যকৰীতা, লগতে বিপণন, ব্যক্তিগতকৰণ আৰু বিশ্লেষণ সক্ষম কৰিবলৈ কুকিজ সংৰক্ষণ কৰোঁ। \"সকলো গ্ৰহণ কৰক\" ক্লিক কৰি, আপুনি আমাৰ কুকিজৰ ব্যৱহাৰত সন্মতি প্ৰদান কৰে। আপুনি যিকোনো সময়তে আপোনাৰ ছেটিংছ সলনি কৰিব পাৰে। কুকি নীতি।",
        "learnMore": "স্বনিৰ্বাচিত কৰক",
        "changeDescription": " "
      },
      "save": "গ্ৰহণ কৰক",
      "consentModal": {
        "title": "সন্মতি পছন্দসমূহ অনুকূলিত কৰক-বেনাৰ> অ 'ভেলে, অপ্ট ইন আৰু ভাৰতীয় আৰু জিটি ভাষাসমূহ",
    ...
    "mai": {
      ...
      "consentNotice": {
        "description": "हम अहाँक गोपनीयता के सम्मान करैत छी-बैनर> ओवले, ऑप्ट इन आ भारतीय आ जीटी भाषा हम आवश्यक साइट कार्यक्षमता के संग-संग विपणन, वैयक्तिकरण आ विश्लेषण के सक्षम करै लेल कुकीज स्टोर करैत छी। \"सभ स्वीकार करू\" पर क्लिक कऽ अहाँ हमर कुकीजक उपयोगक लेल सहमति दैत छी। अहाँ कोनो समय अपन व्यवस्था बदल सकैत छी। कुकी नीति।",
        "learnMore": "अनुकूलित करू",
        "changeDescription": " "
      },
      "save": "स्वीकार करू",
      "consentModal": {
        "title": "सहमति वरीयता केँ अनुकूलित करू-बैनर> ओवले, ऑप्ट इन आ भारतीय आ जीटी भाषा",
    ...
    "bn": {
      ...
      "ok": "সব গ্রহণ করুন",
      "consentNotice": {
        "description": "আমরা আপনার গোপনীয়তাকে সম্মান করি-ব্যানার> ওভেলে, অপ্ট ইন এবং ভারতীয় এবং জিটি ভাষাগুলি আমরা প্রয়োজনীয় সাইট কার্যকারিতা, পাশাপাশি বিপণন, ব্যক্তিগতকরণ এবং বিশ্লেষণ সক্ষম করতে কুকিজ সঞ্চয় করি। \"সবাইকে গ্রহণ করুন\"-এ ক্লিক করে, আপনি আমাদের কুকি ব্যবহারের জন্য সম্মত হন। আপনি যে কোনও সময় আপনার সেটিংস পরিবর্তন করতে পারেন। কুকি নীতি।",
        "learnMore": "কাস্টমাইজ করুন",
        "changeDescription": " "
      },
      "save": "গ্রহণ করুন",
      "consentModal": {
        "title": "সম্মতি পছন্দগুলি কাস্টমাইজ করুন-ব্যানার> ওভেলে, অপ্ট ইন এবং ভারতীয় ও জিটি ভাষাগুলি",
    ...
    "gu": {
      ...
      "ok": "બધાને સ્વીકારો",
      "consentNotice": {
        "description": "અમે તમારી ગોપનીયતાનો આદર કરીએ છીએ-બૅનર> ઓવલે, ઓપ્ટ ઇન અને ભારતીય અને જીટી ભાષાઓ અમે આવશ્યક સાઇટ કાર્યક્ષમતા, તેમજ માર્કેટિંગ, વ્યક્તિગતકરણ અને વિશ્લેષણને સક્ષમ કરવા માટે કૂકીઝ સંગ્રહિત કરીએ છીએ. \"બધા સ્વીકારો\" પર ક્લિક કરીને, તમે અમારા કૂકીઝના ઉપયોગ માટે સંમતિ આપો છો. તમે કોઈપણ સમયે તમારી સેટિંગ્સ બદલી શકો છો. કૂકી નીતિ.",
        "learnMore": "કસ્ટમાઇઝ કરો",
        "changeDescription": " "
      },
      "save": "સ્વીકારો",
      "consentModal": {
        "title": "સંમતિ પસંદગીઓને કસ્ટમાઇઝ કરો-બૅનર> ઓવલે, ઓપ્ટ ઇન અને ભારતીય અને જીટી ભાષાઓ",
    ...
    "kn": {
      ...
      "consentNotice": {
        "description": "ನಿಮ್ಮ ಗೌಪ್ಯತೆಯನ್ನು ನಾವು ಗೌರವಿಸುತ್ತೇವೆ-ಬ್ಯಾನರ್> ಒವೆಲೆ, ಆಪ್ಟ್ ಇನ್ ಮತ್ತು ಭಾರತೀಯ ಮತ್ತು ಜಿಟಿ ಭಾಷೆಗಳು ಅಗತ್ಯ ಸೈಟ್ ಕಾರ್ಯವನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಲು ನಾವು ಕುಕೀಗಳನ್ನು ಸಂಗ್ರಹಿಸುತ್ತೇವೆ, ಜೊತೆಗೆ ಮಾರ್ಕೆಟಿಂಗ್, ವೈಯಕ್ತೀಕರಣ ಮತ್ತು ವಿಶ್ಲೇಷಣೆ. \"ಎಲ್ಲರನ್ನೂ ಸ್ವೀಕರಿಸಿ\" ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ, ನೀವು ನಮ್ಮ ಕುಕೀಗಳ ಬಳಕೆಯನ್ನು ಒಪ್ಪುತ್ತೀರಿ. ನೀವು ಯಾವುದೇ ಸಮಯದಲ್ಲಿ ನಿಮ್ಮ ಸೆಟ್ಟಿಂಗ್ಗಳನ್ನು ಬದಲಾಯಿಸಬಹುದು. ಕುಕೀ ನೀತಿ.",
        "learnMore": "ಕಸ್ಟಮೈಸ್ ಮಾಡಿ",
        "changeDescription": " "
      },
      "save": "ಸ್ವೀಕರಿಸಿ",
      "consentModal": {
        "title": "ಸಮ್ಮತಿ ಆದ್ಯತೆಗಳನ್ನು ಕಸ್ಟಮೈಸ್ ಮಾಡಿ-ಬ್ಯಾನರ್> ಒವೆಲೆ, ಆಪ್ಟ್ ಇನ್ ಮತ್ತು ಭಾರತೀಯ ಮತ್ತು ಜಿಟಿ ಭಾಷೆಗಳು",
    ...
    "ne": {
      ...
      "consentNotice": {
        "description": "हामी तपाईंको गोपनीयतालाई सम्मान गर्दछौं-ब्यानर> ओभेले, अप्ट इन र भारतीय र जीटी भाषाहरू हामीले आवश्यक साइट कार्यक्षमता, साथै मार्केटिङ, निजीकरण र विश्लेषण सक्षम गर्न कुकीहरू भण्डार गर्दछौं। \"सबै स्वीकार गर्नुहोस्\" मा क्लिक गरेर, तपाईं हाम्रो कुकीजको प्रयोगमा सहमत हुनुहुन्छ। तपाईँले कुनै पनि समयमा आफ्नो सेटिङहरू परिवर्तन गर्न सक्नुहुन्छ। कुकी नीति।",
        "learnMore": "अनुकूलित गर्नुहोस्",
        "changeDescription": " "
      },
      "save": "स्वीकार गर्नुहोस्",
      "consentModal": {
        "title": "सहमति प्राथमिकताहरू अनुकूलित गर्नुहोस्-ब्यानर> ओभेले, अप्ट इन र भारतीय र जीटी भाषाहरू",
    ...
    "hi": {
      ...
      "consentNotice": {
        "description": "हम आपकी गोपनीयता का सम्मान करते हैं-बैनर> ओवले, ऑप्ट इन और भारतीय और जी. टी. भाषाएँ हम आवश्यक साइट कार्यक्षमता के साथ-साथ विपणन, वैयक्तिकरण और विश्लेषण को सक्षम करने के लिए कुकीज़ संग्रहीत करते हैं। \"सभी को स्वीकार करें\" पर क्लिक करके, आप कुकीज़ के हमारे उपयोग के लिए सहमत हैं। आप किसी भी समय अपनी सेटिंग बदल सकते हैं। कुकी नीति।",
        "learnMore": "अनुकूलित करें",
        "changeDescription": " "
      },
      "save": "स्वीकार करें",
      "consentModal": {
        "title": "सहमति वरीयताओं को अनुकूलित करें-बैनर> ओवले, ऑप्ट इन और भारतीय और जी. टी. भाषाएँ",
    ...
    "gom": {
      ...
      "ok": "सगळें मान्य कर",
      "consentNotice": {
        "description": "आमी तुमच्या गुप्ततायेचो आदर करतात-बॅनर> ओवले, ऑप्ट इन आनी भारतीय आनी जी. टी. भाशे आमी गरजेच्यो संकेतथळ कार्यक्षमताय, तशेंच विपणन, वैयक्तीकरण आनी विश्लेशण सक्षम करपा खातीर कुकीज सांठोवन दवरतात. \"सगळे मान्य करात\" क्लिकेल्यार, तुमी आमचे कुकीज वापरपाक मान्यताय दितात. तुमी खंयच्याय वेळार तुमची सेटिंग बदलूंक शकतात. कुकी धोरण.",
        "learnMore": "कस्टमायझ करात",
        "changeDescription": " "
      },
      "save": "स्विकार कर",
      "consentModal": {
        "title": "संमतीची पसंती सानुकूल करात-बॅनर> ओवले, निवड आनी भारतीय आनी जी. टी. भाशे",
    ...
    "pa": {
      ...
      "ok": "ਸਭ ਸਵੀਕਾਰ ਕਰੋ",
      "consentNotice": {
        "description": "ਅਸੀਂ ਤੁਹਾਡੀ ਗੋਪਨੀਯਤਾ ਦਾ ਸਨਮਾਨ ਕਰਦੇ ਹਾਂ-ਬੈਨਰ> ਓਵਲੇ, ਆਪਟ ਇਨ ਅਤੇ ਭਾਰਤੀ ਅਤੇ ਜੀ. ਟੀ. ਭਾਸ਼ਾਵਾਂ ਅਸੀਂ ਜ਼ਰੂਰੀ ਸਾਈਟ ਕਾਰਜਕੁਸ਼ਲਤਾ ਦੇ ਨਾਲ-ਨਾਲ ਮਾਰਕੀਟਿੰਗ, ਵਿਅਕਤੀਗਤਕਰਨ ਅਤੇ ਵਿਸ਼ਲੇਸ਼ਣ ਨੂੰ ਸਮਰੱਥ ਬਣਾਉਣ ਲਈ ਕੂਕੀਜ਼ ਨੂੰ ਸਟੋਰ ਕਰਦੇ ਹਾਂ। \"ਸਭ ਨੂੰ ਸਵੀਕਾਰ ਕਰੋ\" ਉੱਤੇ ਕਲਿਕ ਕਰਕੇ, ਤੁਸੀਂ ਸਾਡੀਆਂ ਕੂਕੀਜ਼ ਦੀ ਵਰਤੋਂ ਲਈ ਸਹਿਮਤੀ ਦਿੰਦੇ ਹੋ। ਤੁਸੀਂ ਕਿਸੇ ਵੀ ਸਮੇਂ ਆਪਣੀਆਂ ਸੈਟਿੰਗਾਂ ਨੂੰ ਬਦਲ ਸਕਦੇ ਹੋ। ਕੂਕੀ ਨੀਤੀ.",
        "learnMore": "ਅਨੁਕੂਲਿਤ ਕਰੋ",
        "changeDescription": " "
      },
      "save": "ਸਵੀਕਾਰ ਕਰੋ",
      "consentModal": {
        "title": "ਸਹਿਮਤੀ ਤਰਜੀਹਾਂ ਨੂੰ ਅਨੁਕੂਲਿਤ ਕਰੋ-ਬੈਨਰ> ਓਵਲੇ, ਚੋਣ ਕਰੋ ਅਤੇ ਭਾਰਤੀ ਅਤੇ ਜੀ. ਟੀ. ਭਾਸ਼ਾਵਾਂ",
    ...
    "sa": {
      ...
      "ok": "सर्वं स्वीकरोतु",
      "consentNotice": {
        "description": "वयं भवतः गोपनीयतायाः आदरं कुर्मः-ब्यानर्> ओवेल्, आप्ट्-इन् तथा च भारतीय-भाषा-भाषाः आवश्यक-जालपुट-कार्यक्षमतां, अपि च विपणनं, वैयक्तिकरणं, विश्लेषणं च समर्थयितुं वयं कुकीस् सञ्चालयामः। \"सर्वान् स्वीकरोतु\" इति क्लिक् कृत्वा, भवान् अस्माकं कुकीस् इत्यस्य उपयोगाय सम्मतिं ददति। भवान् कस्मिंश्चित् अपि स्वस्य सेट्टिङ्ग्स् परिवर्तयितुं शक्नोति। कुकी नीतिः।",
        "learnMore": "कस्टमैस् कुरु",
        "changeDescription": " "
      },
      "save": "स्वीकरोतु",
      "consentModal": {
        "title": "सम्मतिप्राधान्यानि स्वकीयानि करोतु-ब्यानर्> ओवेल्, आप्ट्-इन् तथा भारतीय-जी. टी. भाषाः",
    ...
    "it": {
      ...
      "ok": "Accetta tutto",
      "consentNotice": {
        "description": "Rispettiamo la tua privacy - Banner &gt; Ovelay, Opt in e lingue indiane e GT Memorizziamo i cookie per abilitare le funzionalità essenziali del sito, nonché marketing, personalizzazione e analisi. Facendo clic su &quot;Accetta tutto&quot;, acconsenti all&#39;utilizzo dei cookie. Puoi modificare le tue impostazioni in qualsiasi momento. Informativa sui cookie.",
        "learnMore": "Personalizza",
        "changeDescription": " "
      },
      "save": "Accettare",
      "consentModal": {
        "title": "Personalizza le preferenze di consenso - Banner &gt; Overlay, Opt in e lingue indiane e GT",
    ...
    "es": {
      ...
      "ok": "Aceptar todo",
      "consentNotice": {
        "description": "Respetamos tu privacidad - Banner &gt; Superposición, suscripción e idiomas indios y GT. Almacenamos cookies para habilitar la funcionalidad esencial del sitio, así como para marketing, personalización y análisis. Al hacer clic en &quot;Aceptar todo&quot;, aceptas nuestro uso de cookies. Puedes cambiar tu configuración en cualquier momento. Política de cookies.",
        "learnMore": "Personalizar",
        "changeDescription": " "
      },
      "save": "Aceptar",
      "consentModal": {
        "title": "Personalizar preferencias de consentimiento - Banner &gt; Superposición, suscripción e idiomas de India y GT",
