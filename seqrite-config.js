...
window.klaroConfig = {
  ...
  "uuid": "fe8d4f11-120f-4276-a18f-fcb76b5674d1",
  ...
  "translations": {
    ...
    "es": {
      ...
      "ok": "Aceptar todo",
      "consentNotice": {
        "description": "<p>Respetamos tu privacidad -post config 2. Almacenamos cookies para habilitar la funcionalidad esencial del sitio, así como para marketing, personalización y análisis. Al hacer clic en \"Aceptar todo\", aceptas nuestro uso de cookies. Puedes cambiar tu configuración en cualquier momento. Política de cookies.</p>",
        "learnMore": "Personalizar",
        "changeDescription": " "
      },
      "save": "Aceptar",
      "consentModal": {
        "title": "<p>Personalizar las preferencias de consentimiento en la publicación onfig</p>",
    ...
    "de": {
      ...
      "ok": "Alle akzeptieren",
      "consentNotice": {
        "description": "Wir respektieren Ihre Privatsphäre. – Beitragskonfiguration 2. Wir verwenden Cookies, um grundlegende Website-Funktionen sowie Marketing-, Personalisierungs- und Analysezwecke zu ermöglichen. Mit einem Klick auf „Alle akzeptieren“ stimmen Sie der Verwendung von Cookies zu. Sie können Ihre Einstellungen jederzeit ändern. Cookie-Richtlinie.",
        "learnMore": "Anpassen",
        "changeDescription": " "
      },
      "save": "Akzeptieren",
      "consentModal": {
        "title": "Zustimmungseinstellungen anpassen (Beitrags-Onfig)",
