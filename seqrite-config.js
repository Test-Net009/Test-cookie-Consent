...
window.klaroConfig = {
  ...
  "uuid": "dccb197f-dd4a-4c68-a587-bb625f7dfe75",
  ...
  "translations": {
    "english": {
      "acceptAll": "Accept all1",
      "accept": "Accept1",
      "decline": "Decline",
      "acceptSelected": "Accept Selected",
      "ok": "OK",
      "consentNotice": {
        "description": "<p><strong>We respect your privacy - Demo Purpose</strong></p><p>We store cookies to enable essential site functionality, as well as marketing, personalization and analytics. By clicking “Accept All”, you consent to our use of cookies. You can change your settings at any time. <a href=\"https://www.google.com/\" title=\"https://www.google.com/\" target=\"_blank\"><u>Cookie Policy.</u></a></p>",
        "learnMore": "Customize",
        "changeDescription": " "
      },
      "save": "Accept1",
      "consentModal": {
        "title": "<p>Customize Consent Preferences - <strong>- Demo Purpose</strong></p>",
        "description": "<p><u>We use cookies to help you navigate between pages efficiently, storing your preferences, and generally improving your experience of a website. However, we acknowledge your right to privacy and hence you can choose not to allow some types of cookies. Click on the different category headings to find out more and change our default settings. Please note that blocking certain types of cookies might affect your experience of the site. </u></p>",
        "buttons": {
          "save": "Accept1",
          "acceptAll": "Accept all1",
          "decline": "Decline"
    ...
    "ks": {
      "acceptAll": "تمام قبول کر۔ 1",
      "accept": "قبوٗل۔ 1",
      "decline": "کم کرن۔",
      "acceptSelected": "منتخب کر قبول۔",
      "ok": "اوکے۔",
      "consentNotice": {
        "description": "أسۍ چھ تہنٛز راز دٲری ہنٛد احترام کران-ڈیمو پرپوز أسۍ چھ ضروری سایٹہ ہنٛز فعالیتس سۭتۍ سۭتۍ مارکیٹنگ، پرسنلائزیشن تہٕ تجزیاتن فعال کرنہٕ خٲطرٕ کوکیز ذخیرٕ کران۔ \"تمام قبول کرو\" کلک کرتھ، تہۍ چھو سانۍ کوکیز استعمال کرنہٕ خٲطرٕ رضامند۔ تہۍ ہیٚکو کنہ تہ وقتہٕ پنٕنۍ سیٹنگہٕ تبدیل کٔرتھ۔ کوکی پالیسی۔",
        "learnMore": "کسٹمائز کر۔",
        "changeDescription": " "
      },
      "save": "قبوٗل۔ 1",
      "consentModal": {
        "title": "رضامندی ہنز ترجیحات کر کسٹمائز-- ڈیمو پرپوز",
    ...
    "ml": {
      "acceptAll": "എല്ലാവരെയും സ്വീകരിക്കുക1",
      "accept": "സ്വീകരിക്കുക1",
      "decline": "താഴോട്ട്",
      "acceptSelected": "തിരഞ്ഞെടുത്തവ സ്വീകരിക്കുക",
      "ok": "ശരി",
      "consentNotice": {
        "description": "നിങ്ങളുടെ സ്വകാര്യതയെ ഞങ്ങൾ മാനിക്കുന്നു-ഡെമോ പർപ്പസ് അവശ്യ സൈറ്റ് പ്രവർത്തനക്ഷമത, മാർക്കറ്റിംഗ്, വ്യക്തിഗതമാക്കൽ, വിശകലനം എന്നിവ പ്രാപ്തമാക്കുന്നതിന് ഞങ്ങൾ കുക്കികൾ സംഭരിക്കുന്നു. \"എല്ലാം സ്വീകരിക്കുക\" ക്ലിക്കുചെയ്യുന്നതിലൂടെ, ഞങ്ങളുടെ കുക്കികളുടെ ഉപയോഗത്തിന് നിങ്ങൾ സമ്മതിക്കുന്നു. നിങ്ങൾക്ക് എപ്പോൾ വേണമെങ്കിലും നിങ്ങളുടെ ക്രമീകരണങ്ങൾ മാറ്റാം. കുക്കി നയം.",
        "learnMore": "ഇഷ്ടാനുസൃതമാക്കുക",
        "changeDescription": " "
      },
      "save": "സ്വീകരിക്കുക1",
      "consentModal": {
        "title": "സമ്മത മുൻഗണനകൾ ഇഷ്ടാനുസൃതമാക്കുക-ഡെമോ പർപ്പസ്",
    ...
    "mni": {
      "acceptAll": "ꯄꯨꯝꯅꯃꯛ ꯂꯧꯕꯤꯌꯨ 1",
      "accept": "ꯂꯧꯁꯤꯟꯕꯤꯕ 1",
      "decline": "ꯍꯟꯊꯔꯛꯎ",
      "acceptSelected": "ꯈꯟꯒꯠꯂꯕ ꯑꯁꯤ ꯂꯧꯕꯤꯌꯨ",
      "ok": "ꯐꯖꯅ ꯂꯩ ꯫",
      "consentNotice": {
        "description": "ꯑꯩꯈꯣꯏꯅ ꯅꯍꯥꯛꯀꯤ ꯂꯟꯅꯥꯏꯕꯨ ꯏꯀꯥꯏ ꯈꯨꯝꯅꯩ-ꯗꯦꯃꯣ ꯄꯔꯄꯖ ꯑꯩꯈꯣꯏꯅ ꯇꯉꯥꯏꯐꯗꯕ ꯁꯥꯏꯠ ꯃꯊꯧ ꯇꯧꯕ ꯉꯝꯍꯟꯅꯕ ꯀꯨꯀꯤꯁꯤꯡ ꯊꯝꯃꯤ, ꯃꯁꯤꯒ ꯂꯣꯏꯅꯅ ꯃꯥꯔꯀꯦꯇꯤꯡ, ꯄꯦꯁ ꯭ ꯅꯦꯜꯥꯏꯖꯦꯁꯟ ꯑꯃꯁꯨꯡ ꯑꯦꯅꯥꯂꯤꯇꯤꯛꯁꯁꯨ ꯇꯧꯋꯤ ꯫ \"ꯄꯨꯝꯅꯃꯛ ꯌꯥꯕꯤꯌꯨ\" ꯍꯥꯏꯕ ꯑꯗꯨꯗ ꯅꯝꯗꯨꯅ, ꯅꯍꯥꯛꯅ ꯑꯩꯈꯣꯏꯒꯤ ꯀꯨꯀꯤꯁꯤꯡ ꯁꯤꯖꯤꯟꯅꯕ ꯌꯥꯔꯦ ꯫ ꯅꯍꯥꯛꯅ ꯃꯇꯝ ꯑꯃꯍꯦꯛꯇꯗ ꯅꯍꯥꯛꯀꯤ ꯁꯦꯇꯤꯡꯁ ꯑꯗꯨ ꯍꯣꯡꯗꯣꯛꯄ ꯌꯥꯏ ꯫ ꯀꯨꯀꯤꯒꯤ ꯊꯧꯁꯤꯜ ꯫",
        "learnMore": "ꯀꯁꯇꯃꯥꯏꯖ ꯇꯧ ꯫",
        "changeDescription": " "
      },
      "save": "ꯂꯧꯁꯤꯟꯕꯤꯕ 1",
      "consentModal": {
        "title": "ꯀꯁꯇꯣꯃꯥꯏꯖ ꯀꯟꯁꯦꯟꯠ ꯄ ꯭ ꯔꯦꯐꯔꯦꯟꯁ-- ꯗꯦꯃꯣ ꯄꯔꯁ",
    ...
    "sat": {
      "acceptAll": "ᱥᱟᱱᱟᱢ ᱠᱚ ᱦᱟᱛᱟᱣ ᱢᱮ 1",
      "accept": "ᱦᱟᱛᱟᱣ ᱢᱮ 1",
      "decline": "ᱞᱟᱛᱟᱨ ᱢᱮ ᱾",
      "acceptSelected": "ᱵᱟᱪᱷᱱᱟᱣ ᱦᱟᱛᱟᱣ ᱢᱮ ᱾",
      "ok": "ᱵᱷᱟᱜᱮ ᱠᱟᱱᱟ ᱾",
      "consentNotice": {
        "description": "ᱟᱢ ᱟᱢᱟᱜ ᱜᱚᱭᱱᱟᱥᱤ ᱨᱮᱭᱟᱜ ᱢᱟᱹᱱ ᱮᱢᱼᱟᱼ ᱰᱮᱢᱳ ᱯᱚᱨᱯᱟᱥ ᱟᱢ ᱫᱚ ᱵᱮᱼᱵᱟᱹᱛᱤᱞ ᱥᱟᱭᱤᱴ ᱨᱮᱭᱟᱜ ᱠᱟᱹᱢᱤ ᱫᱟᱲᱮ ᱥᱟᱶ ᱥᱟᱶᱛᱮ ᱵᱟᱡᱟᱨ, ᱵᱮᱼᱵᱟᱹᱛᱤᱞ ᱟᱨ ᱚᱱᱚᱞᱤᱠᱤᱥ ᱠᱚᱨᱟᱣ ᱞᱟᱹᱜᱤᱫ ᱠᱩᱠᱤ ᱠᱚ ᱫᱚᱦᱚ ᱮᱫᱟ ᱾ \"ᱥᱟᱱᱟᱢᱟᱜ ᱦᱟᱛᱟᱣ ᱢᱮ\" ᱨᱮ ᱠᱞᱤᱠ ᱠᱟᱛᱮ, ᱟᱢ ᱤᱧᱟᱹᱜ ᱠᱩᱠᱤᱠᱚ ᱵᱮᱶᱦᱟᱨ ᱞᱟᱹᱜᱤᱫ ᱮ ᱥᱤᱜᱤᱞ ᱞᱮᱱᱟ ᱾ ᱟᱢ ᱡᱟᱦᱟᱸ ᱚᱠᱛᱚ ᱨᱮᱦᱚᱸ ᱟᱢᱟᱜ ᱥᱮᱴᱤᱝ ᱠᱚ ᱵᱚᱱᱚᱫᱚᱞ ᱫᱟᱲᱮᱭᱟᱜᱼᱟ ᱾ ᱠᱩᱠᱤ ᱟᱹᱨᱤ ᱾",
        "learnMore": "ᱠᱟᱥᱴᱚᱢᱟᱭᱤᱡ ᱢᱮ ᱾",
        "changeDescription": " "
      },
      "save": "ᱦᱟᱛᱟᱣ ᱢᱮ 1",
      "consentModal": {
        "title": "ᱥᱳᱯᱨᱳᱫᱽ ᱨᱮ ᱥᱚᱨᱮᱥᱟᱱ ᱠᱚ ᱜᱚᱴᱟᱼᱵᱩᱴᱟᱹ ᱢᱮᱼ ᱰᱮᱢᱳ ᱯᱚᱨᱯᱟᱥ ᱾",
    ...
    "ur": {
      "acceptAll": "سب کو قبول کریں 1",
      "accept": "قبول کریں 1",
      "decline": "گراوٹ",
      "acceptSelected": "منتخب کردہ کو قبول کریں",
      "ok": "ٹھیک ہے۔",
      "consentNotice": {
        "description": "ہم آپ کی رازداری کا احترام کرتے ہیں-ڈیمو پرپز ہم سائٹ کی ضروری فعالیت کے ساتھ مارکیٹنگ، شخصی کاری اور تجزیات کو فعال کرنے کے لیے کوکیز کو محفوظ کرتے ہیں۔ \"سب کو قبول کریں\" پر کلک کرکے، آپ ہمارے کوکیز کے استعمال سے اتفاق کرتے ہیں۔ آپ کسی بھی وقت اپنی ترتیبات تبدیل کر سکتے ہیں۔ کوکی پالیسی۔",
        "learnMore": "اپنی مرضی کے مطابق بنائیں",
        "changeDescription": " "
      },
      "save": "قبول کریں 1",
      "consentModal": {
        "title": "رضامندی کی ترجیحات کو حسب ضرورت بنائیں-- ڈیمو پرپوز",
    ...
    "brx": {
      "acceptAll": "गासिबोखौ नाजाव",
      "accept": "नाजाव 1",
      "decline": "गाहायाव फै",
      "acceptSelected": "सायख 'जानायखौ नाजाव",
      "ok": "मोजां",
      "consentNotice": {
        "description": "जों नोंनि प्राइभेसिखौ मान होयो-डेम 'पारपास जों गोनांथार साइटनि खामानिजों लोगोसे मार्केटिं, पार्सनेलाइजेशन आरो एनालाइटिक्स खालामनो थाखाय कुकिजखौ दोनथुमो। \"गासिबो नाजाव\" आव क्लिक खालामनानै, नों जोंनि कुकिफोरनि बाहायनायखौ गनायो। नोंथाङा जायखिजाया समावनो गावनि सेटिंसखौ सोलायनो हायो। कुकि पलिसि।",
        "learnMore": "कास्टमाइज खालाम",
        "changeDescription": " "
      },
      "save": "नाजाव 1",
      "consentModal": {
        "title": "गनायथि सायख 'नायफोरखौ कास्टमाइज खालाम-- डेम' पारपास",
    ...
    "mr": {
      "acceptAll": "सर्व स्वीकारा 1",
      "accept": "स्वीकार 1",
      "decline": "घसरण",
      "acceptSelected": "निवडलेले स्वीकारा",
      "ok": "ठीक आहे",
      "consentNotice": {
        "description": "आम्ही तुमच्या गोपनीयतेचा आदर करतो-डेमो पर्पज आम्ही आवश्यक साइट कार्यक्षमता, तसेच विपणन, वैयक्तिकरण आणि विश्लेषण सक्षम करण्यासाठी कुकीज संचयित करतो. \"सर्व स्वीकारा\" वर क्लिक करून, तुम्ही आमच्या कुकीजच्या वापरासंमती देता. तुम्ही कधीही तुमचे सेटिंग बदलू शकता. कुकी धोरण.",
        "learnMore": "सानुकूलित करा",
        "changeDescription": " "
      },
      "save": "स्वीकार 1",
      "consentModal": {
        "title": "संमतीची प्राधान्ये सानुकूलित करा-- डेमो उद्देश",
    ...
    "or": {
      "acceptAll": "ସମସ୍ତଙ୍କୁ ଗ୍ରହଣ କରନ୍ତୁ1",
      "accept": "ଗ୍ରହଣ କରନ୍ତୁ1",
      "decline": "ହ୍ରାସ କରନ୍ତୁ",
      "acceptSelected": "ମନୋନୀତଙ୍କୁ ଗ୍ରହଣ କରନ୍ତୁ",
      "ok": "ଠିକ ଅଛି",
      "consentNotice": {
        "description": "ଆମେ ଆପଣଙ୍କ ଗୋପନୀୟତାକୁ ସମ୍ମାନ କରୁ-ଡେମୋ ପର୍ପସ୍ ଆମେ ଅତ୍ୟାବଶ୍ୟକ ସାଇଟ୍ କାର୍ଯ୍ୟକାରିତା, ତଥା ମାର୍କେଟିଂ, ବ୍ୟକ୍ତିଗତକରଣ ଏବଂ ବିଶ୍ଳେଷଣକୁ ସକ୍ଷମ କରିବାକୁ କୁକିଜ୍ ଷ୍ଟୋର୍ କରୁ। \"ସମସ୍ତଙ୍କୁ ଗ୍ରହଣ କରନ୍ତୁ\" ଉପରେ କ୍ଲିକ୍ କରି, ଆପଣ ଆମର କୁକିଜ୍ ବ୍ୟବହାର ପାଇଁ ରାଜି ହୁଅନ୍ତି। ଆପଣ ଯେକୌଣସି ସମୟରେ ନିଜର ସେଟିଂ ବଦଳାଇ ପାରିବେ। କୁକି ନୀତି।",
        "learnMore": "ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ",
        "changeDescription": " "
      },
      "save": "ଗ୍ରହଣ କରନ୍ତୁ1",
      "consentModal": {
        "title": "ସମ୍ମତି ପସନ୍ଦକୁ ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ-- ଡେମୋ ଉଦ୍ଦେଶ୍ୟ",
    ...
    "mai": {
      "acceptAll": "सभकेँ स्वीकार करू1",
      "accept": "स्वीकार करू1",
      "decline": "घटैत अछि",
      "acceptSelected": "चुनल गेलकेँ स्वीकार करू",
      "ok": "ठीक अछि",
      "consentNotice": {
        "description": "हम अहाँक गोपनीयता के सम्मान करैत छी-डेमो पर्पस हम आवश्यक साइट कार्यक्षमता के संग-संग विपणन, वैयक्तिकरण आ विश्लेषण के सक्षम करै लेल कुकीज स्टोर करैत छी। \"सभ स्वीकार करू\" पर क्लिक कऽ अहाँ हमर कुकीजक उपयोगक लेल सहमति दैत छी। अहाँ कोनो समय अपन व्यवस्था बदल सकैत छी। कुकी नीति।",
        "learnMore": "अनुकूलित करू",
        "changeDescription": " "
      },
      "save": "स्वीकार करू1",
      "consentModal": {
        "title": "सहमति वरीयता केँ अनुकूलित करू-- डेमो उद्देश्य",
    ...
    "as": {
      "acceptAll": "সকলো 1 গ্ৰহণ কৰক",
      "accept": "গ্ৰহণ 1",
      "decline": "হ্ৰাস কৰক",
      "acceptSelected": "নিৰ্বাচিত গ্ৰহণ কৰক",
      "ok": "ঠিক আছে",
      "consentNotice": {
        "description": "আমি আপোনাৰ গোপনীয়তাক সন্মান কৰোঁ-ডেমো উদ্দেশ্য আমি অত্যাৱশ্যকীয় ছাইট কাৰ্য্যকৰীতা, লগতে বিপণন, ব্যক্তিগতকৰণ আৰু বিশ্লেষণ সক্ষম কৰিবলৈ কুকিজ সংৰক্ষণ কৰোঁ। \"সকলো গ্ৰহণ কৰক\" ক্লিক কৰি, আপুনি আমাৰ কুকিজৰ ব্যৱহাৰত সন্মতি প্ৰদান কৰে। আপুনি যিকোনো সময়তে আপোনাৰ ছেটিংছ সলনি কৰিব পাৰে। কুকি নীতি।",
        "learnMore": "স্বনিৰ্বাচিত কৰক",
        "changeDescription": " "
      },
      "save": "গ্ৰহণ 1",
      "consentModal": {
        "title": "সন্মতি পছন্দসমূহ স্বনিৰ্ধাৰণ কৰক-- ডেমো উদ্দেশ্য",
    ...
    "sd": {
      ...
      "ok": "ٺیڪ آھی۔",
      "consentNotice": {
        "description": "اسان توہان جی رازداری جو احترام ڪریون ٿا-ڊیمو مقصد اسان ضروری سائیٽ جی ڪارڪردگی کی فعال ڪرڻ لاء ڪوڪیز کی اسٽور ڪریون ٿا، گڏوگڏ مارڪیٽنگ، ذاتی ڪرڻ ۽ تجزیا ڪلڪ ڪندی \"سڀنی کی قبول ڪریو\" توہان اسان جی ڪوڪیز جی استعمال لاء رضامند آہیو توھان پنھنجی سیٽنگن کی ڪنھن بہ وقت تبدیل ڪری سگھو ٿا ڪوڪی پالسیء",
        "learnMore": "حسب ضرورت ٺاہیو",
        "changeDescription": " "
      },
      "save": "قبول 1",
      "consentModal": {
        "title": "رضامندی جی ترجیحن کی ترتیب ڏیو-- ڊیمو مقصد",
    ...
    "bn": {
      "acceptAll": "সকলকে গ্রহণ করুন 1",
      "accept": "গ্রহণ করুন 1",
      "decline": "পতন",
      "acceptSelected": "নির্বাচিতদের গ্রহণ করুন",
      "ok": "ঠিক আছে",
      "consentNotice": {
        "description": "আমরা আপনার গোপনীয়তাকে সম্মান করি-ডেমো উদ্দেশ্য আমরা প্রয়োজনীয় সাইট কার্যকারিতা, পাশাপাশি বিপণন, ব্যক্তিগতকরণ এবং বিশ্লেষণ সক্ষম করতে কুকিজ সঞ্চয় করি। \"সবাইকে গ্রহণ করুন\"-এ ক্লিক করে, আপনি আমাদের কুকি ব্যবহারের জন্য সম্মত হন। আপনি যে কোনও সময় আপনার সেটিংস পরিবর্তন করতে পারেন। কুকি নীতি।",
        "learnMore": "কাস্টমাইজ করুন",
        "changeDescription": " "
      },
      "save": "গ্রহণ করুন 1",
      "consentModal": {
        "title": "সম্মতি পছন্দগুলি কাস্টমাইজ করুন-- ডেমো উদ্দেশ্য",
    ...
    "gu": {
      "acceptAll": "બધા સ્વીકારો 1",
      "accept": "સ્વીકારો 1",
      "decline": "ઘટાડો",
      "acceptSelected": "પસંદ કરેલ સ્વીકારો",
      "ok": "ઠીક છે",
      "consentNotice": {
        "description": "અમે તમારી ગોપનીયતાનો આદર કરીએ છીએ-ડેમો પર્પઝ અમે આવશ્યક સાઇટ કાર્યક્ષમતા, તેમજ માર્કેટિંગ, વ્યક્તિગતકરણ અને વિશ્લેષણને સક્ષમ કરવા માટે કૂકીઝ સંગ્રહિત કરીએ છીએ. \"બધા સ્વીકારો\" પર ક્લિક કરીને, તમે અમારા કૂકીઝના ઉપયોગ માટે સંમતિ આપો છો. તમે કોઈપણ સમયે તમારી સેટિંગ્સ બદલી શકો છો. કૂકી નીતિ.",
        "learnMore": "કસ્ટમાઇઝ કરો",
        "changeDescription": " "
      },
      "save": "સ્વીકારો 1",
      "consentModal": {
        "title": "સંમતિ પસંદગીઓને કસ્ટમાઇઝ કરો-- ડેમો હેતુ",
    ...
    "ne": {
      "acceptAll": "सबै स्वीकार गर्नुहोस् 1",
      "accept": "स्वीकार 1",
      "decline": "घट्यो",
      "acceptSelected": "चुनिएको स्वीकार गर्नुहोस्",
      "ok": "ठिक छ",
      "consentNotice": {
        "description": "हामी तपाईंको गोपनीयतालाई सम्मान गर्दछौं-डेमो उद्देश्य हामी आवश्यक साइट कार्यक्षमता, साथै मार्केटिङ, निजीकरण र विश्लेषण सक्षम गर्न कुकीहरू भण्डार गर्दछौं। \"सबै स्वीकार गर्नुहोस्\" मा क्लिक गरेर, तपाईं हाम्रो कुकीजको प्रयोगमा सहमत हुनुहुन्छ। तपाईँले कुनै पनि समयमा आफ्नो सेटिङहरू परिवर्तन गर्न सक्नुहुन्छ। कुकी नीति।",
        "learnMore": "अनुकूलित गर्नुहोस्",
        "changeDescription": " "
      },
      "save": "स्वीकार 1",
      "consentModal": {
        "title": "सहमति प्राथमिकताहरू अनुकूलित गर्नुहोस्-- डेमो उद्देश्य",
    ...
    "hi": {
      "acceptAll": "सभी को स्वीकार करें 1",
      "accept": "स्वीकार करें1",
      "decline": "गिरावट",
      "acceptSelected": "चयनित को स्वीकार करें",
      "ok": "ठीक है",
      "consentNotice": {
        "description": "हम आपकी गोपनीयता का सम्मान करते हैं-डेमो पर्पस हम आवश्यक साइट कार्यक्षमता के साथ-साथ विपणन, वैयक्तिकरण और विश्लेषण को सक्षम करने के लिए कुकीज़ संग्रहीत करते हैं। \"सभी को स्वीकार करें\" पर क्लिक करके, आप कुकीज़ के हमारे उपयोग के लिए सहमत हैं। आप किसी भी समय अपनी सेटिंग बदल सकते हैं। कुकी नीति।",
        "learnMore": "अनुकूलित करें",
        "changeDescription": " "
      },
      "save": "स्वीकार करें1",
      "consentModal": {
        "title": "सहमति वरीयताओं को अनुकूलित करें-- डेमो उद्देश्य",
    ...
    "gom": {
      ...
      "ok": "बरें",
      "consentNotice": {
        "description": "आमी तुज्या गुप्ततायेचो आदर करतात-डेमो पर्पज आमी कुकीज सांठोवन दवरतात जाका लागून गरजेचीं सायटीची कार्यक्षमताय, तशेंच मार्केटींग, वैयक्तीकरण आनी विश्लेशण शक्य जाता. \"सगळे मान्य करात\" क्लिकेल्यार, तुमी आमचे कुकीज वापरपाक मान्यताय दितात. तुमी खंयच्याय वेळार तुमची सेटिंग बदलूंक शकतात. कुकी धोरण.",
        "learnMore": "कस्टमायझ करात",
        "changeDescription": " "
      },
      "save": "स्विकार 1",
      "consentModal": {
        "title": "संमतीची पसंती सानुकूल करात-- डेमो पर्पज",
    ...
    "pa": {
      "acceptAll": "ਸਭ 1 ਸਵੀਕਾਰ ਕਰੋ",
      "accept": "ਸਵੀਕਾਰ ਕਰੋ 1",
      "decline": "ਡਿੱਗਣਾ",
      "acceptSelected": "ਚੁਣੇ ਹੋਏ ਨੂੰ ਸਵੀਕਾਰ ਕਰੋ",
      "ok": "ਠੀਕ ਹੈ",
      "consentNotice": {
        "description": "ਅਸੀਂ ਤੁਹਾਡੀ ਗੋਪਨੀਯਤਾ ਦਾ ਸਨਮਾਨ ਕਰਦੇ ਹਾਂ-ਡੈਮੋ ਉਦੇਸ਼ ਅਸੀਂ ਜ਼ਰੂਰੀ ਸਾਈਟ ਕਾਰਜਕੁਸ਼ਲਤਾ ਦੇ ਨਾਲ-ਨਾਲ ਮਾਰਕੀਟਿੰਗ, ਵਿਅਕਤੀਗਤਕਰਨ ਅਤੇ ਵਿਸ਼ਲੇਸ਼ਣ ਨੂੰ ਸਮਰੱਥ ਕਰਨ ਲਈ ਕੂਕੀਜ਼ ਨੂੰ ਸਟੋਰ ਕਰਦੇ ਹਾਂ। \"ਸਭ ਨੂੰ ਸਵੀਕਾਰ ਕਰੋ\" ਉੱਤੇ ਕਲਿਕ ਕਰਕੇ, ਤੁਸੀਂ ਸਾਡੀਆਂ ਕੂਕੀਜ਼ ਦੀ ਵਰਤੋਂ ਲਈ ਸਹਿਮਤੀ ਦਿੰਦੇ ਹੋ। ਤੁਸੀਂ ਕਿਸੇ ਵੀ ਸਮੇਂ ਆਪਣੀਆਂ ਸੈਟਿੰਗਾਂ ਨੂੰ ਬਦਲ ਸਕਦੇ ਹੋ। ਕੂਕੀ ਨੀਤੀ.",
        "learnMore": "ਅਨੁਕੂਲਿਤ ਕਰੋ",
        "changeDescription": " "
      },
      "save": "ਸਵੀਕਾਰ ਕਰੋ 1",
      "consentModal": {
        "title": "ਸਹਿਮਤੀ ਤਰਜੀਹਾਂ ਨੂੰ ਅਨੁਕੂਲਿਤ ਕਰੋ-- ਡੈਮੋ ਉਦੇਸ਼",
    ...
    "sa": {
      "acceptAll": "सर्वान् स्वीकरोतु 1",
      "accept": "स्वीकरोतु1",
      "decline": "अधोगति",
      "acceptSelected": "चयनं स्वीकरोतु",
      "ok": "सम्यक्",
      "consentNotice": {
        "description": "वयं भवतः गोपनीयतायाः आदरं कुर्वन्ति-डेमो-पर्पस्-वयं आवश्यक-जालपुट-कार्यक्षमतां, अपि च विपणनं, वैयक्तिकरणं, विश्लेषणं च समर्थयितुं कुकीस् सञ्चालयामः। \"सर्वान् स्वीकरोतु\" इति क्लिक् कृत्वा, भवान् अस्माकं कुकीस् इत्यस्य उपयोगाय सम्मतिं ददति। भवान् कस्मिंश्चित् अपि स्वस्य सेट्टिङ्ग्स् परिवर्तयितुं शक्नोति। कुकी नीतिः।",
        "learnMore": "कस्टमैस् कुरु",
        "changeDescription": " "
      },
      "save": "स्वीकरोतु1",
      "consentModal": {
        "title": "सहमतिप्राधान्यानि स्वकीयानि करोतु-- डेमो पर्पस्",
    ...
    "ban": {
      "acceptAll": "Nerima sami1",
      "accept": "Nerima1",
      "decline": "Nolak",
      "acceptSelected": "Nrima Sané Kapilih",
      "ok": "INGGIH",
      "consentNotice": {
        "description": "Google ngajinin privasi Sametoné - Tetujon Demo Google nyimpen kuki mangda prasida ngaktifang fungsi situs sané mabuat, taler pemasaran, personalisasi, lan analisis. Antuk ngeklik “Terima Samian”, Sameton setuju sareng kawigunan kuki Google. Sameton dados nguwah setélan sabilang galah. Kabijakan Kuki",
        "learnMore": "Sesuaiang",
        "changeDescription": " "
      },
      "save": "Nerima1",
      "consentModal": {
        "title": "Sesuaiang Preferensi Persetujuan - - Tetujon Demo",
        "description": "Google nganggén kuki anggén ngwantu Sameton navigasi pantaraning laman antuk efisien, nyimpen preferensi Sameton, lan umumnyané nincapang pengalaman Sameton ring situs wéb. Nanging, Google ngangkenin hak privasi Sameton lan mawinan punika Sameton dados milih nénten ngicénin makudang-kudang soroh kuki. Klik ring judul kategori sané matiosan anggén uning sejangkepnyané lan nguwah setélan default Google. Élingang yéning nyengkalen makudang-kudang soroh kuki minab pacang nglalahin pengalaman Sametoné ring situs puniki.",
        "buttons": {
          "save": "Nerima1",
          "acceptAll": "Nerima sami1",
          "decline": "Nolak"
      ...
      "purposes": {
        "Functional": {
          "description": "Google nganggén kuki puniki anggén nincapang fungsi situs wéb lan nincapang pengalaman sanganggé. Gatra prasida madaging data login, genah, basa, miwah daging sané katincapang."
        },
        "Marketing": {
          "description": "Kuki puniki kaanggén olih mitra iklan Google anggén ngirimang iklan pribadi lan ngukur efektivitas kampanye pemasaran. Dané ngwantu ngicénin promosi sané relevan manut minat sanganggé lan parilaksana panylahjah."
        }
      },
      "service": {
        "disableAll": {
