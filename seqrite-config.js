...
window.klaroConfig = {
  ...
  "uuid": "161856da-906e-4086-9ede-446972774c83",
  ...
  "translations": {
    "english": {
      ...
      "save": "Accept",
      "consentModal": {
        "title": "<p>Customize Consent Preferences - <strong>- Demo Purpose on 28th Jan 2026</strong></p>",
    ...
    "ks": {
      ...
      "save": "قبول کرن۔",
      "consentModal": {
        "title": "رضامندی ہنز ترجیحات کسٹمائز کریو-- ڈیمو پرپوز 28 جنوری 2026",
    ...
    "ml": {
      ...
      "save": "സ്വീകരിക്കുക",
      "consentModal": {
        "title": "സമ്മത മുൻഗണനകൾ ഇഷ്ടാനുസൃതമാക്കുക-2026 ജനുവരി 28 ന് ഡെമോ പർപ്പസ്",
    ...
    "mni": {
      ...
      "save": "ꯂꯧꯁꯤꯟꯕꯤꯌꯨ",
      "consentModal": {
        "title": "ꯀꯟꯁꯦꯟꯠ ꯄ ꯭ ꯔꯦꯐꯔꯦꯟꯁꯁꯤꯡ ꯀꯁ ꯭ ꯇꯥꯃꯥꯏꯖ ꯇꯧ-- ꯗꯦꯃꯣ ꯄꯔꯄꯖ 28 ꯖꯅꯨꯋꯥꯔꯤ 2026 ꯗ",
    ...
    "sat": {
      ...
      "save": "ᱦᱟᱛᱟᱣ ᱢᱮ ᱾",
      "consentModal": {
        "title": "ᱥᱳᱯᱨᱩᱢᱟᱱᱟᱜ ᱵᱟᱪᱷᱱᱟᱣ ᱠᱚ ᱠᱟᱥᱴᱚᱢᱟᱭᱤᱡᱽ ᱢᱮᱼᱼᱼ2026 ᱥᱟᱹᱦᱤᱛ ᱨᱮᱭᱟᱜ 28 ᱡᱟᱱᱩᱭᱟᱹᱨᱤ ᱨᱮ ᱰᱮᱢᱳ ᱯᱚᱨᱯᱟᱥ ᱾",
    ...
    "ur": {
      ...
      "save": "قبول کریں۔",
      "consentModal": {
        "title": "رضامندی کی ترجیحات کو حسب ضرورت بنائیں-- ڈیمو پرپز 28 جنوری 2026 کو",
    ...
    "brx": {
      ...
      "save": "नाजाव",
      "consentModal": {
        "title": "गनायथि सायख 'नायफोरखौ कास्टमाइज खालाम-- 28 जानुआरि 2026 आव डेम' पारपास",
    ...
    "mr": {
      ...
      "save": "स्वीकारा",
      "consentModal": {
        "title": "संमती प्राधान्ये सानुकूलित करा-- डेमो पर्पज 28 जानेवारी 2026 रोजी",
    ...
    "or": {
      ...
      "save": "ଗ୍ରହଣ କରନ୍ତୁ",
      "consentModal": {
        "title": "ସହମତି ପସନ୍ଦକୁ ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ-- 28 ଜାନୁଆରୀ 2026 ରେ ଡେମୋ ଉଦ୍ଦେଶ୍ୟ",
    ...
    "as": {
      ...
      "ok": "সকলো গ্ৰহণ কৰক",
      "consentNotice": {
        "description": "<p>আমি আপোনাৰ গোপনীয়তাক সন্মান কৰোঁ-ডেমো উদ্দেশ্য আমি অত্যাৱশ্যকীয় ছাইট কাৰ্য্যকৰীতা, লগতে বিপণন, ব্যক্তিগতকৰণ আৰু বিশ্লেষণ সক্ষম কৰিবলৈ কুকিজ সংৰক্ষণ কৰোঁ। \"সকলো গ্ৰহণ কৰক\" ক্লিক কৰি, আপুনি আমাৰ কুকিজৰ ব্যৱহাৰত সন্মতি প্ৰদান কৰে। আপুনি যিকোনো সময়তে আপোনাৰ ছেটিংছ সলনি কৰিব পাৰে। কুকি নীতি।</p>",
        "learnMore": "স্বনিৰ্বাচিত কৰক",
        "changeDescription": " "
      },
      "save": "গ্ৰহণ কৰক",
      "consentModal": {
        "title": "<p>সন্মতিৰ অগ্ৰাধিকাৰসমূহ অনুকূলিত কৰক-- 2026 চনৰ 28 জানুৱাৰীত ডেমো উদ্দেশ্য</p>",
    ...
    "mai": {
      ...
      "save": "स्वीकार करू",
      "consentModal": {
        "title": "सहमति वरीयता केँ अनुकूलित करू-- डेमो उद्देश्य 28 जनवरी 2026 केँ",
    ...
    "ta": {
      ...
      "save": "ஏற்றுக்கொள்",
      "consentModal": {
        "title": "சம்மத விருப்பங்களைத் தனிப்பயனாக்குங்கள்-- டெமோ நோக்கம் 28 ஜனவரி 2026 அன்று",
    ...
    "bn": {
      ...
      "save": "গ্রহণ করুন",
      "consentModal": {
        "title": "সম্মতি পছন্দগুলি কাস্টমাইজ করুন-- 2026 সালের 28শে জানুয়ারি ডেমো উদ্দেশ্য",
    ...
    "te": {
      ...
      "save": "అంగీకరించండి",
      "consentModal": {
        "title": "సమ్మతి ప్రాధాన్యతలను అనుకూలీకరించండి-- 2026 జనవరి 28న డెమో పర్పస్",
    ...
    "kn": {
      ...
      "save": "ಸ್ವೀಕರಿಸಿ",
      "consentModal": {
        "title": "ಒಪ್ಪಿಗೆಯ ಆದ್ಯತೆಗಳನ್ನು ಕಸ್ಟಮೈಸ್ ಮಾಡಿ-- 2026ರ ಜನವರಿ 28ರಂದು ಡೆಮೊ ಉದ್ದೇಶ",
    ...
    "gu": {
      ...
      "save": "સ્વીકારો",
      "consentModal": {
        "title": "સંમતિ પસંદગીઓને કસ્ટમાઇઝ કરો-- 28મી જાન્યુઆરી 2026ના રોજ ડેમો પર્પઝ",
    ...
    "hi": {
      ...
      "save": "स्वीकार करें",
      "consentModal": {
        "title": "सहमति वरीयताओं को अनुकूलित करें-- 28 जनवरी 2026 को डेमो उद्देश्य",
    ...
    "gom": {
      ...
      "save": "स्विकार कर",
      "consentModal": {
        "title": "संमतीची पसंती सानुकूल करात-- डेमो पर्पज 28 जानेवारी 2026 दिसा",
    ...
    "pa": {
      ...
      "save": "ਸਵੀਕਾਰ ਕਰੋ",
      "consentModal": {
        "title": "ਸਹਿਮਤੀ ਤਰਜੀਹਾਂ ਨੂੰ ਅਨੁਕੂਲਿਤ ਕਰੋ-- 28 ਜਨਵਰੀ 2026 ਨੂੰ ਡੈਮੋ ਉਦੇਸ਼",
    ...
    "sa": {
      ...
      "save": "स्वीकरोतु",
      "consentModal": {
        "title": "सहमतिप्राधान्यतां स्व्यकरोतु-- डेमो पर्पस् 28 जनवरी 2026 दिनाङ्के",
