...
window.klaroConfig = {
  "consentManagerId": "68f2881f447e516f112a973c",
  "uuid": "0443e05c-7906-4f8b-aac4-b99ddb22eb2e",
  "domain": "https://680ixj.sqdataprivacy.com/cmapi",
  "version": 1,
  "elementID": "SEQRITE",
  lang: userLang,
  ...
  "translations": {
    "english": {
      ...
      "ok": "Accept All",
      "consentNotice": {
        "description": "<p><strong>We respect your privacy in SDP production -Cookie 2.3.3</strong></p><p>We store cookies to enable essential site functionality, as well as marketing, personalization and analytics. By clicking “Accept All”, you consent to our use of cookies. You can change your settings at any time. <a href=\"https://www.google.com/\" title=\"https://www.google.com/\" target=\"_blank\"><u>Cookie Policy.</u></a></p>",
        "learnMore": "Customize",
        "changeDescription": " "
      },
      "save": "Accept",
      "consentModal": {
        "title": "<p>Customize Consent Preferences -<strong>SDP production -Cookie 2.3.3</strong></p>",
    ...
    "ks": {
      ...
      "ok": "سٲری کر قبوٗل۔",
      "consentNotice": {
        "description": "أسۍ چھ ایس ڈی پی پروڈکشنس منٛز تہنٛز راز دٲری ہنٛد احترام کران-کوکی 2.3 أسۍ چھ ضروری سایٹہ ہنٛز فعالیتس سۭتۍ سۭتۍ مارکیٹنگ، پرسنلائزیشن تہٕ تجزیاتن فعال کرنہٕ خٲطرٕ کوکیز ذخیرٕ کران۔ \"تمام قبول کرو\" کلک کرتھ، تہۍ چھو سانۍ کوکیز استعمال کرنہٕ خٲطرٕ رضامند۔ تہۍ ہیٚکو کنہ تہ وقتہٕ پنٕنۍ سیٹنگہٕ تبدیل کٔرتھ۔ کوکی پالیسی۔",
        "learnMore": "کسٹمائز کر۔",
        "changeDescription": " "
      },
      "save": "قبول کرن۔",
      "consentModal": {
        "title": "رضامندی ہنز ترجیحات کسٹمائز کریو-ایس ڈی پی پروڈکشن-کوکی 2.3",
    ...
    "doi": {
      ...
      "consentNotice": {
        "description": "अस एसडीपी उत्पादन च तुंʼदी निजता दा सम्मान करदे आं-कुकी 2.3.3 अस जरूरी साइट कार्यक्षमता दे कन्नै-कन्नै मार्केटिंग, निजीकरण ते विश्लेषिकी गी सक्षम करने आस्तै कुकीज स्टोर करदे आं। \"सभनें गी मंजूर करो\" पर क्लिक करियै, तुस साड़ियां कुकीज़ दे इस्तेमाल आस्तै सैह्मती दिंदे ओ। तुस कुसै बी समें अपनी सेटिंग बदली सकदे ओ। कुकी नीति।",
        "learnMore": "अनुकूलित करो",
        "changeDescription": " "
      },
      "save": "मंजूर करो",
      "consentModal": {
        "title": "सहमति वरीयताएं गी अनुकूलित करो-एस. डी. पी. उत्पादन-कुकी 2.3",
    ...
    "ml": {
      ...
      "consentNotice": {
        "description": "എസ്ഡിപി ഉൽപ്പാദനത്തിലെ നിങ്ങളുടെ സ്വകാര്യതയെ ഞങ്ങൾ മാനിക്കുന്നു-കുക്കി 2.3.3 അവശ്യ സൈറ്റ് പ്രവർത്തനക്ഷമത, മാർക്കറ്റിംഗ്, വ്യക്തിഗതമാക്കൽ, വിശകലനം എന്നിവ പ്രാപ്തമാക്കുന്നതിന് ഞങ്ങൾ കുക്കികൾ സംഭരിക്കുന്നു. \"എല്ലാം സ്വീകരിക്കുക\" ക്ലിക്കുചെയ്യുന്നതിലൂടെ, ഞങ്ങളുടെ കുക്കികളുടെ ഉപയോഗത്തിന് നിങ്ങൾ സമ്മതിക്കുന്നു. നിങ്ങൾക്ക് എപ്പോൾ വേണമെങ്കിലും നിങ്ങളുടെ ക്രമീകരണങ്ങൾ മാറ്റാം. കുക്കി നയം.",
        "learnMore": "ഇഷ്ടാനുസൃതമാക്കുക",
        "changeDescription": " "
      },
      "save": "സ്വീകരിക്കുക",
      "consentModal": {
        "title": "സമ്മത മുൻഗണനകൾ ഇഷ്ടാനുസൃതമാക്കുക-എസ്ഡിപി ഉൽപ്പാദനം-കുക്കി 2.3.3",
    ...
    "mni": {
      ...
      "ok": "ꯄꯨꯝꯅꯃꯛ ꯂꯧꯕꯤꯌꯨ",
      "consentNotice": {
        "description": "ꯑꯩꯈꯣꯏꯅ ꯑꯦꯁ. ꯗꯤ. ꯄꯤ. ꯄꯨꯊꯣꯛꯄꯗ ꯅꯍꯥꯛꯀꯤ ꯂꯟꯅꯥꯏ ꯑꯣꯏꯕ ꯑꯗꯨ ꯏꯀꯥꯏꯈꯨꯝꯅꯩ-ꯀꯨꯀꯤ 2.3.3 ꯑꯩꯈꯣꯏꯅ ꯇꯉꯥꯏꯐꯗꯕ ꯁꯥꯏꯠ ꯃꯊꯧ ꯇꯧꯕ ꯉꯝꯅꯕ, ꯃꯥꯔꯀꯦꯇꯤꯡ, ꯄꯦꯁ ꯭ ꯅꯦꯜꯥꯏꯖꯦꯁꯟ ꯑꯃꯁꯨꯡ ꯑꯦꯅꯥꯂꯤꯇꯤꯛꯁ ꯇꯧꯕ ꯉꯝꯅꯕ ꯀꯨꯀꯤꯁꯤꯡ ꯊꯝꯃꯤ ꯫ \"ꯄꯨꯝꯅꯃꯛ ꯌꯥꯕꯤꯌꯨ\" ꯍꯥꯏꯕ ꯑꯗꯨꯗ ꯅꯝꯗꯨꯅ, ꯅꯍꯥꯛꯅ ꯑꯩꯈꯣꯏꯒꯤ ꯀꯨꯀꯤꯁꯤꯡ ꯁꯤꯖꯤꯟꯅꯕ ꯌꯥꯔꯦ ꯫ ꯅꯍꯥꯛꯅ ꯃꯇꯝ ꯑꯃꯍꯦꯛꯇꯗ ꯅꯍꯥꯛꯀꯤ ꯁꯦꯇꯤꯡꯁ ꯑꯗꯨ ꯍꯣꯡꯗꯣꯛꯄ ꯌꯥꯏ ꯫ ꯀꯨꯀꯤꯒꯤ ꯊꯧꯁꯤꯜ ꯫",
        "learnMore": "ꯀꯁꯇꯃꯥꯏꯖ ꯇꯧ ꯫",
        "changeDescription": " "
      },
      "save": "ꯂꯧꯁꯤꯟꯕꯤꯌꯨ",
      "consentModal": {
        "title": "ꯀꯁꯇꯣꯃꯥꯏꯖ ꯀꯟꯁꯦꯟꯠ ꯄ ꯭ ꯔꯦꯐꯔꯦꯟꯁꯁ-ꯑꯦꯁ. ꯗꯤ. ꯄꯤ. ꯄ ꯭ ꯔꯣꯗꯛꯁꯟ-ꯀꯨꯀꯤ 2.3.3",
    ...
    "sat": {
      ...
      "consentNotice": {
        "description": "ᱟᱢ ᱮᱥᱰᱤᱯᱤ ᱵᱮᱱᱟᱣ ᱨᱮ ᱟᱢᱟᱜ ᱜᱚᱭᱱᱟᱥᱤ ᱨᱮᱭᱟᱜ ᱢᱟᱹᱱ ᱮᱢ ᱮᱫᱟᱼᱠᱩᱠᱤ 2.3.3 ᱟᱢ ᱫᱚ ᱟᱹᱰᱤ ᱞᱟᱹᱠᱛᱤ ᱥᱟᱭᱤᱴ ᱨᱮᱭᱟᱜ ᱠᱟᱹᱢᱤ ᱫᱟᱲᱮ ᱥᱟᱶ ᱥᱟᱶᱛᱮ ᱵᱤᱪᱷᱱᱟᱶ, ᱵᱮᱼᱵᱟᱹᱛᱤᱞ ᱟᱨ ᱚᱱᱚᱞᱤᱠᱤᱥ ᱠᱚᱨᱟᱣ ᱞᱟᱹᱜᱤᱫ ᱠᱩᱠᱤ ᱠᱚ ᱫᱚᱦᱚ ᱮᱫᱟ ᱾ \"ᱥᱟᱱᱟᱢᱟᱜ ᱦᱟᱛᱟᱣ ᱢᱮ\" ᱨᱮ ᱠᱞᱤᱠ ᱠᱟᱛᱮ, ᱟᱢ ᱤᱧᱟᱹᱜ ᱠᱩᱠᱤᱠᱚ ᱵᱮᱶᱦᱟᱨ ᱞᱟᱹᱜᱤᱫ ᱮ ᱥᱤᱜᱤᱞ ᱞᱮᱱᱟ ᱾ ᱟᱢ ᱡᱟᱦᱟᱸ ᱚᱠᱛᱚ ᱨᱮᱦᱚᱸ ᱟᱢᱟᱜ ᱥᱮᱴᱤᱝ ᱠᱚ ᱵᱚᱱᱚᱫᱚᱞ ᱫᱟᱲᱮᱭᱟᱜᱼᱟ ᱾ ᱠᱩᱠᱤ ᱟᱹᱨᱤ ᱾",
        "learnMore": "ᱠᱟᱥᱴᱚᱢᱟᱭᱤᱡ ᱢᱮ ᱾",
        "changeDescription": " "
      },
      "save": "ᱦᱟᱛᱟᱣ ᱢᱮ ᱾",
      "consentModal": {
        "title": "ᱪᱩᱠᱤᱼᱥᱤᱰᱤᱯᱤ ᱵᱮᱱᱟᱣᱼᱥᱤᱰᱤᱯᱤᱼᱥᱤᱰᱤᱯᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤᱼᱥᱤᱰᱤ ᱾",
    ...
    "ur": {
      ...
      "ok": "سب کو قبول کریں",
      "consentNotice": {
        "description": "ہم ایس ڈی پی پروڈکشن میں آپ کی رازداری کا احترام کرتے ہیں-کوکی 2.3 ہم سائٹ کی ضروری فعالیت کے ساتھ ساتھ مارکیٹنگ، شخصی کاری اور تجزیات کو فعال کرنے کے لیے کوکیز کو ذخیرہ کرتے ہیں۔ \"سب کو قبول کریں\" پر کلک کرکے، آپ ہمارے کوکیز کے استعمال سے اتفاق کرتے ہیں۔ آپ کسی بھی وقت اپنی ترتیبات تبدیل کر سکتے ہیں۔ کوکی پالیسی۔",
        "learnMore": "اپنی مرضی کے مطابق بنائیں",
        "changeDescription": " "
      },
      "save": "قبول کریں۔",
      "consentModal": {
        "title": "رضامندی کی ترجیحات کو حسب ضرورت بنائیں-ایس ڈی پی پروڈکشن-کوکی 2.3",
    ...
    "mr": {
      ...
      "ok": "सर्व स्वीकारा",
      "consentNotice": {
        "description": "एस. डी. पी. निर्मितीमध्ये तुमच्या गोपनीयतेचा आम्ही आदर करतो-कुकी 2.3. आवश्यक संकेतस्थळ कार्यक्षमता, तसेच विपणन, वैयक्तिकरण आणि विश्लेषण सक्षम करण्यासाठी आम्ही कुकीज संचयित करतो. \"सर्व स्वीकारा\" वर क्लिक करून, तुम्ही आमच्या कुकीजच्या वापरास संमती देता. तुम्ही कधीही तुमचे सेटिंग बदलू शकता. कुकी धोरण.",
        "learnMore": "सानुकूलित करा",
        "changeDescription": " "
      },
      "save": "स्वीकारा",
      "consentModal": {
        "title": "संमती प्राधान्ये सानुकूलित करा-एस. डी. पी. उत्पादन-कुकी 2.3.3",
    ...
    "or": {
      ...
      "consentNotice": {
        "description": "ଆମେ ଏସଡିପି ଉତ୍ପାଦନରେ ଆପଣଙ୍କ ଗୋପନୀୟତାକୁ ସମ୍ମାନ କରୁ-କୁକି 2.3.......................................................................................................................................................................................... \"ସମସ୍ତଙ୍କୁ ଗ୍ରହଣ କରନ୍ତୁ\" ଉପରେ କ୍ଲିକ୍ କରି, ଆପଣ ଆମର କୁକିଜ୍ ବ୍ୟବହାର ପାଇଁ ରାଜି ହୁଅନ୍ତି। ଆପଣ ଯେକୌଣସି ସମୟରେ ନିଜର ସେଟିଂ ବଦଳାଇ ପାରିବେ। କୁକି ନୀତି।",
        "learnMore": "ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ",
        "changeDescription": " "
      },
      "save": "ଗ୍ରହଣ କରନ୍ତୁ",
      "consentModal": {
        "title": "ସମ୍ମତି ପସନ୍ଦ-ଏସ. ଡି. ପି. ଉତ୍ପାଦନ-କୁକି 2.3.3",
    ...
    "as": {
      ...
      "ok": "সকলো গ্ৰহণ কৰক",
      "consentNotice": {
        "description": "আমি এছ. ডি. পি. প্ৰযোজনাত আপোনাৰ গোপনীয়তাক সন্মান কৰোঁ-কুকি 2.3 আমি অত্যাৱশ্যকীয় ছাইট কাৰ্য্যকৰীতা, লগতে বিপণন, ব্যক্তিগতকৰণ আৰু বিশ্লেষণ সক্ষম কৰিবলৈ কুকিজ সংৰক্ষণ কৰোঁ। \"সকলো গ্ৰহণ কৰক\" ক্লিক কৰি, আপুনি আমাৰ কুকিজৰ ব্যৱহাৰত সন্মতি প্ৰদান কৰে। আপুনি যিকোনো সময়তে আপোনাৰ ছেটিংছ সলনি কৰিব পাৰে। কুকি নীতি।",
        "learnMore": "স্বনিৰ্বাচিত কৰক",
        "changeDescription": " "
      },
      "save": "গ্ৰহণ কৰক",
      "consentModal": {
        "title": "সন্মতি পছন্দসমূহ অনুকূলিত কৰক-এছ. ডি. পি. উৎপাদন-কুকি 2.3.3",
    ...
    "mai": {
      ...
      "consentNotice": {
        "description": "हम एसडीपी उत्पादन मे अहाँक गोपनीयता के सम्मान करैत छी-कुकी 2.3 हम आवश्यक साइट कार्यक्षमता के संग-संग विपणन, वैयक्तिकरण आ विश्लेषण के सक्षम करै लेल कुकीज स्टोर करैत छी। \"सभ स्वीकार करू\" पर क्लिक कऽ अहाँ हमर कुकीजक उपयोगक लेल सहमति दैत छी। अहाँ कोनो समय अपन व्यवस्था बदल सकैत छी। कुकी नीति।",
        "learnMore": "अनुकूलित करू",
        "changeDescription": " "
      },
      "save": "स्वीकार करू",
      "consentModal": {
        "title": "सहमति वरीयता-एस. डी. पी. उत्पादन-कुकी 2.3",
    ...
    "bn": {
      ...
      "ok": "সব গ্রহণ করুন",
      "consentNotice": {
        "description": "আমরা এসডিপি উৎপাদনে আপনার গোপনীয়তাকে সম্মান করি-কুকি 2.3 আমরা প্রয়োজনীয় সাইট কার্যকারিতা, পাশাপাশি বিপণন, ব্যক্তিগতকরণ এবং বিশ্লেষণ সক্ষম করতে কুকিজ সঞ্চয় করি। \"সবাইকে গ্রহণ করুন\"-এ ক্লিক করে, আপনি আমাদের কুকি ব্যবহারের জন্য সম্মত হন। আপনি যে কোনও সময় আপনার সেটিংস পরিবর্তন করতে পারেন। কুকি নীতি।",
        "learnMore": "কাস্টমাইজ করুন",
        "changeDescription": " "
      },
      "save": "গ্রহণ করুন",
      "consentModal": {
        "title": "সম্মতি পছন্দগুলি কাস্টমাইজ করুন-এসডিপি উৎপাদন-কুকি 2.3",
    ...
    "kn": {
      ...
      "consentNotice": {
        "description": "ಎಸ್ಡಿಪಿ ಉತ್ಪಾದನೆಯಲ್ಲಿ ನಿಮ್ಮ ಗೌಪ್ಯತೆಯನ್ನು ನಾವು ಗೌರವಿಸುತ್ತೇವೆ-ಕುಕೀ 2.3. ಅಗತ್ಯವಾದ ಸೈಟ್ ಕಾರ್ಯವನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಲು ನಾವು ಕುಕೀಗಳನ್ನು ಸಂಗ್ರಹಿಸುತ್ತೇವೆ, ಜೊತೆಗೆ ಮಾರ್ಕೆಟಿಂಗ್, ವೈಯಕ್ತೀಕರಣ ಮತ್ತು ವಿಶ್ಲೇಷಣೆ. \"ಎಲ್ಲರನ್ನೂ ಸ್ವೀಕರಿಸಿ\" ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ, ನೀವು ನಮ್ಮ ಕುಕೀಗಳ ಬಳಕೆಯನ್ನು ಒಪ್ಪುತ್ತೀರಿ. ನೀವು ಯಾವುದೇ ಸಮಯದಲ್ಲಿ ನಿಮ್ಮ ಸೆಟ್ಟಿಂಗ್ಗಳನ್ನು ಬದಲಾಯಿಸಬಹುದು. ಕುಕೀ ನೀತಿ.",
        "learnMore": "ಕಸ್ಟಮೈಸ್ ಮಾಡಿ",
        "changeDescription": " "
      },
      "save": "ಸ್ವೀಕರಿಸಿ",
      "consentModal": {
        "title": "ಸಮ್ಮತಿ ಆದ್ಯತೆಗಳನ್ನು ಗ್ರಾಹಕೀಯಗೊಳಿಸಿ-ಎಸ್. ಡಿ. ಪಿ. ಉತ್ಪಾದನೆ-ಕುಕೀ 2.3.3",
    ...
    "gu": {
      ...
      "ok": "બધાને સ્વીકારો",
      "consentNotice": {
        "description": "અમે એસડીપી ઉત્પાદનમાં તમારી ગોપનીયતાનો આદર કરીએ છીએ-કૂકી 2.3. અમે આવશ્યક સાઇટ કાર્યક્ષમતા, તેમજ માર્કેટિંગ, વ્યક્તિગતકરણ અને વિશ્લેષણને સક્ષમ કરવા માટે કૂકીઝ સંગ્રહિત કરીએ છીએ. \"બધા સ્વીકારો\" પર ક્લિક કરીને, તમે અમારા કૂકીઝના ઉપયોગ માટે સંમતિ આપો છો. તમે કોઈપણ સમયે તમારી સેટિંગ્સ બદલી શકો છો. કૂકી નીતિ.",
        "learnMore": "કસ્ટમાઇઝ કરો",
        "changeDescription": " "
      },
      "save": "સ્વીકારો",
      "consentModal": {
        "title": "સંમતિ પસંદગીઓને કસ્ટમાઇઝ કરો-એસ. ડી. પી. ઉત્પાદન-કૂકી 2.3",
    ...
    "ne": {
      ...
      "consentNotice": {
        "description": "हामी एसडीपी उत्पादनमा तपाईंको गोपनीयतालाई सम्मान गर्दछौं-कुकी 2.3.3 हामी आवश्यक साइट कार्यक्षमता, साथै मार्केटिङ, निजीकरण र विश्लेषण सक्षम गर्न कुकीहरू भण्डार गर्दछौं। \"सबै स्वीकार गर्नुहोस्\" मा क्लिक गरेर, तपाईं हाम्रो कुकीजको प्रयोगमा सहमत हुनुहुन्छ। तपाईँले कुनै पनि समयमा आफ्नो सेटिङहरू परिवर्तन गर्न सक्नुहुन्छ। कुकी नीति।",
        "learnMore": "अनुकूलित गर्नुहोस्",
        "changeDescription": " "
      },
      "save": "स्वीकार गर्नुहोस्",
      "consentModal": {
        "title": "सहमति प्राथमिकताहरू अनुकूलित गर्नुहोस्-एसडिपी उत्पादन-कुकी 2.3",
    ...
    "hi": {
      ...
      "consentNotice": {
        "description": "हम एसडीपी उत्पादन में आपकी गोपनीयता का सम्मान करते हैं-कुकी 2.3 हम आवश्यक साइट कार्यक्षमता के साथ-साथ विपणन, वैयक्तिकरण और विश्लेषण को सक्षम करने के लिए कुकीज़ संग्रहीत करते हैं। \"सभी को स्वीकार करें\" पर क्लिक करके, आप कुकीज़ के हमारे उपयोग के लिए सहमत हैं। आप किसी भी समय अपनी सेटिंग बदल सकते हैं। कुकी नीति।",
        "learnMore": "अनुकूलित करें",
        "changeDescription": " "
      },
      "save": "स्वीकार करें",
      "consentModal": {
        "title": "सहमति वरीयताएँ-एस. डी. पी. उत्पादन-कुकी को अनुकूलित करें",
    ...
    "gom": {
      ...
      "ok": "सगळें मान्य कर",
      "consentNotice": {
        "description": "एस. डी. पी. उत्पादनांत तुमच्या गुप्ततायेचो आमी आदर करतात-कुकी 2.3.3 आमी गरजेच्यो संकेतथळ कार्यक्षमताय, तशेंच विपणन, वैयक्तीकरण आनी विश्लेशण सक्षम करपा खातीर कुकीज सांठोवन दवरतात. \"सगळे मान्य करात\" क्लिक केल्यार, तुमी आमचे कुकीज वापरपाक मान्यताय दितात. तुमी खंयच्याय वेळार तुमची सेटिंग बदलूंक शकतात. कुकी धोरण.",
        "learnMore": "कस्टमायझ करात",
        "changeDescription": " "
      },
      "save": "स्विकार कर",
      "consentModal": {
        "title": "संमतीची पसंती-एस. डी. पी. उत्पादन-कुकी सानुकूल करात",
    ...
    "pa": {
      ...
      "ok": "ਸਭ ਸਵੀਕਾਰ ਕਰੋ",
      "consentNotice": {
        "description": "ਅਸੀਂ ਐੱਸ. ਡੀ. ਪੀ. ਉਤਪਾਦਨ ਵਿੱਚ ਤੁਹਾਡੀ ਗੋਪਨੀਯਤਾ ਦਾ ਸਨਮਾਨ ਕਰਦੇ ਹਾਂ-ਕੂਕੀ 2.3 ਅਸੀਂ ਜ਼ਰੂਰੀ ਸਾਈਟ ਕਾਰਜਕੁਸ਼ਲਤਾ ਦੇ ਨਾਲ-ਨਾਲ ਮਾਰਕੀਟਿੰਗ, ਵਿਅਕਤੀਗਤਕਰਨ ਅਤੇ ਵਿਸ਼ਲੇਸ਼ਣ ਨੂੰ ਸਮਰੱਥ ਬਣਾਉਣ ਲਈ ਕੂਕੀਜ਼ ਨੂੰ ਸਟੋਰ ਕਰਦੇ ਹਾਂ। \"ਸਭ ਨੂੰ ਸਵੀਕਾਰ ਕਰੋ\" ਉੱਤੇ ਕਲਿਕ ਕਰਕੇ, ਤੁਸੀਂ ਸਾਡੀਆਂ ਕੂਕੀਜ਼ ਦੀ ਵਰਤੋਂ ਲਈ ਸਹਿਮਤੀ ਦਿੰਦੇ ਹੋ। ਤੁਸੀਂ ਕਿਸੇ ਵੀ ਸਮੇਂ ਆਪਣੀਆਂ ਸੈਟਿੰਗਾਂ ਨੂੰ ਬਦਲ ਸਕਦੇ ਹੋ। ਕੂਕੀ ਨੀਤੀ.",
        "learnMore": "ਅਨੁਕੂਲਿਤ ਕਰੋ",
        "changeDescription": " "
      },
      "save": "ਸਵੀਕਾਰ ਕਰੋ",
      "consentModal": {
        "title": "ਸਹਿਮਤੀ ਤਰਜੀਹਾਂ-ਐੱਸ. ਡੀ. ਪੀ. ਉਤਪਾਦਨ-ਕੂਕੀ ਨੂੰ ਅਨੁਕੂਲਿਤ ਕਰੋ",
    ...
    "sa": {
      ...
      "ok": "सर्वं स्वीकरोतु",
      "consentNotice": {
        "description": "वयं एस्. डी. पी.-उत्पादने भवतः गोपनीयतायाः आदरं कुर्वन्ति-कुकी 2.3.3 वयं आवश्यक-जालपुट-कार्यक्षमतां समर्थयितुं कुकीस् सञ्चालयामः, तथैव विपणनं, वैयक्तिकरणं, विश्लेषणं च। \"सर्वान् स्वीकरोतु\" इति क्लिक् कृत्वा, भवान् अस्माकं कुकीस् इत्यस्य उपयोगाय सम्मतिं ददति। भवान् कस्मिंश्चित् अपि स्वस्य सेट्टिङ्ग्स् परिवर्तयितुं शक्नोति। कुकी नीतिः।",
        "learnMore": "कस्टमैस् कुरु",
        "changeDescription": " "
      },
      "save": "स्वीकरोतु",
      "consentModal": {
        "title": "सहमतिप्राधान्यतां स्वकीयीकरोतु-एस्. डि. पि. उत्पादनम्-कुकी 2.3.3",
    ...
    "de": {
      ...
      "ok": "Alle akzeptieren",
      "consentNotice": {
        "description": "Wir respektieren Ihre Privatsphäre bei der SDP-Produktion - Cookie 2.3.3 Wir speichern Cookies, um wesentliche Funktionen der Website sowie Marketing, Personalisierung und Analyse zu ermöglichen. Wenn Sie auf „Alle akzeptieren“ klicken, stimmen Sie der Verwendung von Cookies zu. Sie können Ihre Einstellungen jederzeit ändern. Cookie-Richtlinie.",
        "learnMore": "Anpassen",
        "changeDescription": " "
      },
      "save": "Akzeptieren",
      "consentModal": {
        "title": "Zustimmungseinstellungen anpassen -SDP-Produktion -Cookie 2.3.3",
        "description": "Wir verwenden Cookies, um Ihnen die Navigation zwischen den Seiten zu erleichtern, Ihre Präferenzen zu speichern und so Ihre Nutzererfahrung auf der Website allgemein zu verbessern. Wir respektieren Ihr Recht auf Privatsphäre, weshalb Sie bestimmte Cookie-Typen ablehnen können. Klicken Sie auf die verschiedenen Kategorieüberschriften, um mehr zu erfahren und unsere Standardeinstellungen zu ändern. Bitte beachten Sie, dass die Blockierung bestimmter Cookie-Typen Ihre Nutzererfahrung auf der Website beeinträchtigen könnte.",
        "buttons": {
          "save": "Akzeptieren",
          "acceptAll": "Alle akzeptieren",
          "decline": "Alle ablehnen"
      ...
      "purposes": {
        "Analytics": {
          "description": "Diese Cookies helfen uns bei der Analyse des Website-Verkehrs, des Nutzerverhaltens und der Interaktionsmuster. Die gewonnenen Erkenntnisse ermöglichen es uns, Inhalte zu optimieren, die Benutzerfreundlichkeit zu verbessern und die allgemeine Leistung der Website zu steigern."
        },
        "Others": {
          "description": "Diese Kategorie umfasst Cookies, die nicht in die vordefinierten Kategorien passen, aber für bestimmte Website-Funktionen oder -Verbesserungen erforderlich sein können."
        }
      },
      "service": {
        "disableAll": {
