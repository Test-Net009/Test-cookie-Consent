...
window.klaroConfig = {
  "consentManagerId": "6793635fef5738109d86a63f",
  "uuid": "3b4dda58-f70f-4e76-b139-0bfa525727f7",
  "domain": "https://dev-hs.qhtpl.com/cmapi",
  "version": 1,
  "elementID": "SEQRITE",
  lang: userLang,
  "storageMethod": "cookie",
  "storageName": "www.google.com",
  ...
  "translations": {
    ...
    "kashmiri": {
      ...
      "ok": "سٲری کر قبوٗل۔",
      "consentNotice": {
        "description": "<p> <مضبوط> أسۍ چھ تہنٛز راز دٲری ہنٛد احترام کران </مضبوط> </p> <p> أسۍ چھ ضروری سایٹہ ہنٛد فعالیتس سۭتۍ سۭتۍ مارکیٹنگ، پرسنلائزیشن تہٕ تجزیاتن فعال کرنہٕ خٲطرٕ کوکیز ذخیرٕ کران۔ \"تمام قبول کرو\" کلک کٔرتھ، تہۍ چھو سانۍ کوکیز استعمال کرنہٕ خٲطرٕ رضامند۔ تہۍ ہیٚکو کنہٕ تہٕ وقتہٕ پنن سیٹنگ تبدیل کٔرتھ۔ <ahref = \"https://www.google.com\" عنوان = \"https://www.google.com\" ہدف = \"_ خالی\"> <u> کوکی پالیسی۔",
    ...
    "dogri": {
      ...
      "consentNotice": {
        "description": "<p> <सशक्त> अस तुंʼदी निजता दा सम्मान करदे आं </सशक्त> </p> <p> अस जरूरी साइट कार्यक्षमता दे कन्नै-कन्नै मार्केटिंग, निजीकरण ते विश्लेषिकी गी समर्थत करने आस्तै कुकीज़ संचित करदे आं। \"सभनें गी मंजूर करो\" पर क्लिक करियै, तुस कुकीज़ दे इस्तेमाल आस्तै सैह्मती दिंदे ओ। तुस कुसै बी समें अपनी सेटिंग बदली सकदे ओ। <ए हरेफ = \"https://www.google.com\" टाइटल = \"https://www.google.com\" टारगेट = \"_ ब्लैंक\"> <u> कुकी पालिसी। </u> </a> </p>",
    ...
    "malayalam": {
      ...
      "consentNotice": {
        "description": "നിങ്ങളുടെ സ്വകാര്യതയെ ഞങ്ങൾ മാനിക്കുന്നു. അവശ്യ സൈറ്റ് പ്രവർത്തനക്ഷമത, മാർക്കറ്റിംഗ്, വ്യക്തിഗതമാക്കൽ, വിശകലനം എന്നിവ പ്രാപ്തമാക്കുന്നതിന് ഞങ്ങൾ കുക്കികൾ സംഭരിക്കുന്നു. \"എല്ലാം സ്വീകരിക്കുക\" ക്ലിക്കുചെയ്യുന്നതിലൂടെ നിങ്ങൾ ഞങ്ങളുടെ കുക്കികളുടെ ഉപയോഗത്തിന് സമ്മതം നൽകുന്നു. നിങ്ങൾക്ക് എപ്പോൾ വേണമെങ്കിലും നിങ്ങളുടെ ക്രമീകരണങ്ങൾ മാറ്റാൻ കഴിയും.",
    ...
    "manipuri": {
      ...
      "ok": "ꯄꯨꯝꯅꯃꯛ ꯂꯧꯕꯤꯌꯨ",
      "consentNotice": {
        "description": "<p> <ꯁ ꯭ ꯇ ꯭ ꯔꯣꯡ> ꯑꯩꯈꯣꯏꯅ ꯅꯍꯥꯛꯀꯤ ꯂꯟꯅꯥꯏ ꯑꯗꯨ ꯏꯀꯥꯏꯈꯨꯝꯅꯩ </ꯁ ꯭ ꯇ ꯭ ꯔꯣꯡ> </p> ꯑꯩꯈꯣꯏꯅ ꯇꯉꯥꯏꯐꯗꯕ ꯁꯥꯏꯠꯀꯤ ꯃꯊꯧ ꯇꯧꯕ ꯉꯝꯕ, ꯃꯥꯔꯀꯦꯇꯤꯡ, ꯄꯦꯁ ꯭ ꯅꯂꯥꯏꯖꯦꯁꯟ ꯑꯃꯁꯨꯡ ꯑꯦꯅꯥꯂꯤꯇꯤꯛꯁ ꯇꯧꯕ ꯉꯝꯅꯕ ꯀꯨꯀꯤꯁꯤꯡ ꯊꯝꯃꯤ ꯫ \"ꯄꯨꯝꯅꯃꯛ ꯌꯥꯕꯤꯌꯨ\" ꯇ ꯅꯝꯗꯨꯅ, ꯅꯍꯥꯛꯅ ꯑꯩꯈꯣꯏꯒꯤ ꯀꯨꯀꯤꯁꯤꯡ ꯁꯤꯖꯤꯟꯅꯕ ꯌꯥꯔꯦ ꯫ ꯅꯍꯥꯛꯅ ꯃꯇꯝ ꯑꯃꯍꯦꯛꯇꯗ ꯅꯍꯥꯛꯀꯤ ꯁꯦꯇꯤꯡꯁꯤꯡ ꯑꯗꯨ ꯍꯣꯡꯗꯣꯛꯄ ꯌꯥꯏ ꯫ <ahref = \"https://www.google.com\" ꯇꯥꯏꯇꯦꯜ = \"https://www.google.com\" ꯇ ꯭ ꯔꯦꯛꯠ = \"_ ꯕ ꯭ ꯂꯦꯟ\"> <u> ꯀꯨꯀꯤ ꯄꯂꯤꯁꯤ ꯫",
    ...
    "santali": {
      ...
      "consentNotice": {
        "description": "<p> <ᱫᱟᱲᱮ \"<u> ᱠᱩᱠᱤ ᱟᱹᱨᱤ ᱾ </u> </a> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p> </p",
    ...
    "urdu": {
      ...
      "ok": "سب کو قبول کریں",
      "consentNotice": {
        "description": "ہم آپ کی رازداری کا احترام کرتے ہیں۔ ہم ضروری سائٹ کی فعالیت کے ساتھ ساتھ مارکیٹنگ، ذاتی نوعیت اور تجزیات کو فعال کرنے کے لیے کوکیز کو اسٹور کرتے ہیں۔ \"سب کو قبول کریں\" پر کلک کرنے سے آپ ہمارے کوکیز کے استعمال سے اتفاق کرتے ہیں۔ آپ کسی بھی وقت اپنی ترتیبات تبدیل کر سکتے ہیں۔",
    ...
    "bodo": {
      ...
      "ok": "गासिबो नाजाव।",
      "consentNotice": {
        "description": "<p> <strong> जों नोंनि गोथोंथिखौ मान होयो </strong> </p> जों गोनांथार साइटनि खामानि मावनो हानायजों लोगोसे हाथाय खालामनाय, गावारि खालामनाय आरो बिजिरसंनो थाखाय कुकिफोरखौ दोनथुमो। \"गासिबो आजाव\" आव क्लिक खालामनानै नों जोंनि कुकिफोरखौ बाहायनो गनायथि होयो। नों जायखिजाया समावनो गावनि सेटिंसखौ सोलायनो हायो। <ahref = \"https://www.google.com\" टाइटल = \"https://www.google.com\" टारगेट = \"_ ब्लेंक\"> <u> कुकि पलिसि।",
    ...
    "marathi": {
      ...
      "ok": "सर्व स्वीकारा",
      "consentNotice": {
        "description": "<p> <सशक्त> आम्ही तुमच्या गोपनीयतेचा आदर करतो </सशक्त> </p> आम्ही आवश्यक साइट कार्यक्षमता, तसेच विपणन, वैयक्तिकरण आणि विश्लेषण सक्षम करण्यासाठी कुकीज संचयित करतो. \"सर्व स्वीकारा\" वर क्लिक करून, तुम्ही आमच्या कुकीजच्या वापरास संमती देता. तुम्ही कधीही तुमची सेटिंग्ज बदलू शकता. <ahref = \"https://www.google.com\" शीर्षक = \"https://www.google.com\" लक्ष्य = \"_ रिक्त\"> <u> कुकी धोरण.",
    ...
    "odia": {
      ...
      "consentNotice": {
        "description": "ଆମେ ଆପଣଙ୍କ ଗୋପନୀୟତାକୁ ସମ୍ମାନ କରୁ, ଆବଶ୍ୟକ ସାଇଟର କାର୍ଯ୍ୟକାରିତା ତଥା ବିପଣନ, ବ୍ୟକ୍ତିଗତକରଣ ଏବଂ ବିଶ୍ଳେଷଣକୁ ସକ୍ଷମ କରିବା ପାଇଁ ଆମେ କୁକିଜ୍ ଷ୍ଟୋର୍ କରୁ। \"ସମସ୍ତ ଗ୍ରହଣ କରନ୍ତୁ\" ଉପରେ କ୍ଲିକ୍ କରି, ଆପଣ ଆମର କୁକିଜ୍ ବ୍ୟବହାର ପାଇଁ ରାଜି ହୁଅନ୍ତି। ଆପଣ ଯେକୌଣସି ସମୟରେ ଆପଣଙ୍କର ସେଟିଙ୍ଗ୍ ବଦଳାଇପାରିବେ। <ahref = \"https://www.google.com\" ଶୀର୍ଷକ = \"https://www.google.com\" ଲକ୍ଷ୍ୟ = \"_ ଖାଲି\"> <u> କୁକି ନୀତି। </u> </a> </p>",
    ...
    "assamese": {
      ...
      "ok": "সকলো গ্ৰহণ কৰক",
      "consentNotice": {
        "description": "আমি আপোনাৰ গোপনীয়তাক সন্মান কৰোঁ, প্ৰয়োজনীয় ছাইটৰ কাৰ্য্যকলাপৰ লগতে বিপণন, ব্যক্তিগতকৰণ আৰু বিশ্লেষণ সক্ষম কৰিবলৈ আমি কুকিজ সংৰক্ষণ কৰোঁ। \"সকলো গ্ৰহণ কৰক\" ক্লিক কৰি আপুনি আমাৰ কুকিজৰ ব্যৱহাৰত সন্মতি প্ৰকাশ কৰে। আপুনি যিকোনো সময়তে আপোনাৰ ছেটিংছ সলনি কৰিব পাৰে।",
    ...
    "maithili": {
      ...
      "consentNotice": {
        "description": "<p> <सशक्त> हम अहाँक गोपनीयताक सम्मान करैत छी </सशक्त> </p> <p> हम आवश्यक साइटक कार्यक्षमता, सङ्गहि विपणन, वैयक्तिकरण आ विश्लेषणकेँ सक्षम करबा लेल कुकीजकेँ भंडारित करैत छी। \"सभकेँ स्वीकार करू\" पर क्लिक कय अहाँ हमर कुकीजक उपयोगक लेल सहमति दैत छी। अहाँ कोनो समय अपन सेटिंगकेँ बदलि सकैत छी। <ए हरेफ = \"https://www.google.com\" शीर्षक = \"https://www.google.com\" लक्ष्य = \"_ खाली\"> <u> कुकी नीति।",
    ...
    "tamil": {
      ...
      "consentNotice": {
        "description": "உங்கள் தனியுரிமையை நாங்கள் மதிக்கிறோம், அத்தியாவசிய தள செயல்பாடு, சந்தைப்படுத்தல், தனிப்பயனாக்கம் மற்றும் பகுப்பாய்வு ஆகியவற்றை செயல்படுத்த குக்கீகளை சேமித்து வைக்கிறோம். \"அனைத்தையும் ஏற்றுக்கொள்ளுங்கள்\" என்பதைக் கிளிக் செய்வதன் மூலம், நீங்கள் குக்கீகளைப் பயன்படுத்த ஒப்புக்கொள்கிறீர்கள். நீங்கள் எந்த நேரத்திலும் உங்கள் அமைப்புகளை மாற்றலாம்.",
    ...
    "sindhi": {
      ...
      "ok": "سڀ قبول ڪریو",
      "consentNotice": {
        "description": "<p> <مضبوط> اسان توہان جی رازداری جو احترام ڪریون ٿا </مضبوط> </p> اسان ضروری سائیٽ جی ڪارڪردگی کی فعال ڪرڻ لاء ڪوڪیز کی اسٽور ڪریون ٿا، گڏوگڏ مارڪیٽنگ، ذاتی ڪرڻ ۽ تجزیا. ڪلڪ ڪندی \"سڀنی کی قبول ڪریو\" توہان اسان جی ڪوڪیز جی استعمال لاء رضامند آہیو۔ توہان ڪنہن بہ وقت پنہنجون سیٽنگون تبدیل ڪری سگہو ٿا",
    ...
    "bengali": {
      ...
      "ok": "সব গ্রহণ করুন",
      "consentNotice": {
        "description": "আমরা আপনার গোপনীয়তাকে সম্মান করি, প্রয়োজনীয় সাইটের কার্যকারিতা, সেইসাথে বিপণন, ব্যক্তিগতকরণ এবং বিশ্লেষণ সক্ষম করার জন্য আমরা কুকিজ সংরক্ষণ করি। \"সমস্ত গ্রহণ করুন\" ক্লিক করে আপনি আমাদের কুকিজ ব্যবহার করতে সম্মত হন। আপনি যে কোনও সময় আপনার সেটিংস পরিবর্তন করতে পারেন। <এ হারেফ = \"https://www.google.com\" শিরোনাম = \"https://www.google.com\" লক্ষ্য = \"_ ফাঁকা\"> <ইউ> কুকি নীতি।",
    ...
    "telugu": {
      ...
      "consentNotice": {
        "description": "మీ గోప్యతను మేము గౌరవిస్తాము, అవసరమైన సైట్ కార్యాచరణను, అలాగే మార్కెటింగ్, వ్యక్తిగతీకరణ మరియు విశ్లేషణలను ప్రారంభించడానికి మేము కుకీలను నిల్వ చేస్తాము. \"అన్నింటినీ అంగీకరించండి\" క్లిక్ చేయడం ద్వారా, మీరు మా కుకీల వినియోగానికి అంగీకరిస్తారు. మీరు ఎప్పుడైనా మీ సెట్టింగులను మార్చుకోవచ్చు. <a హ్రెఫ్ = \"https://www.google.com\" శీర్షిక = \"https://www.google.com\" లక్ష్యం = \"_ ఖాళీ\"> <u> కుకీ విధానం. </u> </a> </p>",
    ...
    "gujarati": {
      ...
      "ok": "બધાને સ્વીકારો",
      "consentNotice": {
        "description": "અમે તમારી ગોપનીયતાનો આદર કરીએ છીએ અમે આવશ્યક સાઇટ કાર્યક્ષમતા, તેમજ માર્કેટિંગ, વ્યક્તિગતકરણ અને વિશ્લેષણને સક્ષમ કરવા માટે કૂકીઝ સંગ્રહિત કરીએ છીએ. \"બધા સ્વીકારો\" પર ક્લિક કરીને, તમે અમારા કૂકીઝના ઉપયોગ માટે સંમતિ આપો છો. તમે કોઈપણ સમયે તમારી સેટિંગ્સ બદલી શકો છો.",
    ...
    "nepali": {
      ...
      "consentNotice": {
        "description": "<p> <बलियो> हामी तपाईंको गोपनीयतालाई सम्मान गर्दछौँ </बलियो> </p> <p> हामी आवश्यक साइट कार्यक्षमता, साथै मार्केटिङ, निजीकरण र विश्लेषणहरू सक्षम गर्न कुकीहरू भण्डारण गर्दछौँ। \"सबै स्वीकार गर्नुहोस्\" मा क्लिक गरेर, तपाईं हाम्रो कुकीहरूको प्रयोगमा सहमति जनाउनुहुन्छ। तपाईं कुनै पनि समयमा आफ्नो सेटिङहरू परिवर्तन गर्न सक्नुहुन्छ। <a ह्रफ = \"https://www.google.com\" शीर्षक = \"https://www.google.com\" लक्ष्य = \"_ खाली\"> <u> कुकी नीति।",
    ...
    "hindi": {
      ...
      "consentNotice": {
        "description": "हम आपकी गोपनीयता का सम्मान करते हैं हम आवश्यक साइट कार्यक्षमता के साथ-साथ विपणन, वैयक्तिकरण और विश्लेषण को सक्षम करने के लिए कुकीज़ संग्रहीत करते हैं। \"सभी स्वीकार करें\" पर क्लिक करके, आप हमारे कुकीज़ के उपयोग के लिए सहमति देते हैं। आप किसी भी समय अपनी सेटिंग बदल सकते हैं।",
    ...
    "goan konkani": {
      ...
      "ok": "सगळें मान्य कर",
      "consentNotice": {
        "description": "<p> <सशक्त> आमी तुमच्या गुप्ततायेचो आदर करतात </सशक्त> </p> <p> आमी गरजेचीं सायटीची कार्यक्षमताय, तशेंच विपणन, वैयक्तीकरण आनी विश्लेशण सक्षम करपा खातीर कुकीज सांठोवन दवरतात. \"सगळें मान्य करात\" क्लिक करून, तुमी आमचे कुकीज वापरपाक मान्यताय दितात. तुमी खंयच्याय वेळार तुमची सेटिंग बदलूंक शकतात. <ahref = \"https://www.google.com\" शिर्षक = \"https://www.google.com\" लक्ष्य = \"_ रिक्त\"> <u> कुकी धोरण.",
    ...
    "punjabi": {
      ...
      "ok": "ਸਭ ਸਵੀਕਾਰ ਕਰੋ",
      "consentNotice": {
        "description": "ਅਸੀਂ ਤੁਹਾਡੀ ਗੋਪਨੀਯਤਾ ਦਾ ਸਨਮਾਨ ਕਰਦੇ ਹਾਂ ਅਸੀਂ ਜ਼ਰੂਰੀ ਸਾਈਟ ਕਾਰਜਕੁਸ਼ਲਤਾ ਦੇ ਨਾਲ-ਨਾਲ ਮਾਰਕੀਟਿੰਗ, ਵਿਅਕਤੀਗਤਕਰਨ ਅਤੇ ਵਿਸ਼ਲੇਸ਼ਣ ਨੂੰ ਸਮਰੱਥ ਕਰਨ ਲਈ ਕੂਕੀਜ਼ ਨੂੰ ਸਟੋਰ ਕਰਦੇ ਹਾਂ। \"ਸਭ ਨੂੰ ਸਵੀਕਾਰ ਕਰੋ\" ਉੱਤੇ ਕਲਿੱਕ ਕਰਕੇ, ਤੁਸੀਂ ਸਾਡੀਆਂ ਕੂਕੀਜ਼ ਦੀ ਵਰਤੋਂ ਲਈ ਸਹਿਮਤੀ ਦਿੰਦੇ ਹੋ। ਤੁਸੀਂ ਕਿਸੇ ਵੀ ਸਮੇਂ ਆਪਣੀਆਂ ਸੈਟਿੰਗਾਂ ਨੂੰ ਬਦਲ ਸਕਦੇ ਹੋ।",
    ...
    "sanskrit": {
      ...
      "ok": "सर्वं स्वीकरोतु।",
      "consentNotice": {
        "description": "<p> <सशक्त> वयं भवतः गोपनीयतां आदरयामः </सशक्त> </p> <p> वयं आवश्यक-जालपुट-कार्यक्षमतां, तथैव विपणनं, वैयक्तिकरणं तथा विश्लेषणं च समर्थयितुं कुकीस् सञ्चालयामः। \"सर्वं स्वीकरोतु\" इति क्लिक् कृत्वा भवान् अस्माकं कुकीस् इत्यस्य उपयोगाय सम्मतिं ददति। भवान् कस्मिंश्चित् समये अपि स्वस्य सेट्टिङ्ग्स् परिवर्तयितुं शक्नोति। <ahref = \"https://www.google.com\" शीर्षकं = \"https://www.google.com\" लक्ष्यम् = \"_ रिक्तम्\"> <u> कुकी-नीतिः।",
