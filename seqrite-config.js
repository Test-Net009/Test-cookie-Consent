...
window.klaroConfig = {
  ...
  "uuid": "8cad2976-523b-4097-811e-d29b57eaeae9",
  ...
  "translations": {
    ...
    "te": {
      ...
      "accept": "అంగీకరించు",
      "decline": "అన్నీ తిరస్కరించు",
      "acceptSelected": "ఎంచుకున్న వాటిని ఆమోదించు",
      "ok": "అన్నీ అంగీకరించు",
      "consentNotice": {
        "description": "మేము మీ గోప్యతను గౌరవిస్తాము ముఖ్యమైన సైట్ కార్యాచరణను, అలాగే మార్కెటింగ్, వ్యక్తిగతీకరణ మరియు విశ్లేషణలను ప్రారంభించడానికి మేము కుక్కీలను నిల్వ చేస్తాము. “అన్నీ అంగీకరించు” క్లిక్ చేయడం ద్వారా, మీరు మా కుక్కీల వినియోగానికి అంగీకరిస్తున్నారు. మీరు ఎప్పుడైనా మీ సెట్టింగ్‌లను మార్చవచ్చు. కుకీ విధానం.",
      ...
      "consentModal": {
        ...
        "description": "పేజీల మధ్య సమర్థవంతంగా నావిగేట్ చేయడంలో మీకు సహాయపడటానికి, మీ ప్రాధాన్యతలను నిల్వ చేయడానికి మరియు సాధారణంగా వెబ్‌సైట్ యొక్క మీ అనుభవాన్ని మెరుగుపరచడానికి మేము కుక్కీలను ఉపయోగిస్తాము. అయితే, మీ గోప్యత హక్కును మేము గుర్తిస్తాము మరియు అందువల్ల మీరు కొన్ని రకాల కుక్కీలను అనుమతించకూడదని ఎంచుకోవచ్చు. మరింత తెలుసుకోవడానికి మరియు మా డిఫాల్ట్ సెట్టింగ్‌లను మార్చడానికి విభిన్న కేటగిరీ శీర్షికలపై క్లిక్ చేయండి. కొన్ని రకాల కుక్కీలను నిరోధించడం వలన సైట్ యొక్క మీ అనుభవం ప్రభావితం కావచ్చని దయచేసి గమనించండి.",
        "buttons": {
          "save": "అంగీకరించు",
          "acceptAll": "అన్నీ అంగీకరించు",
          "decline": "అన్నీ తిరస్కరించు"
      ...
      "purposes": {
        "Analytics": {
          "description": "ఈ కుక్కీలు వెబ్‌సైట్ ట్రాఫిక్, వినియోగదారు ప్రవర్తన మరియు నిశ్చితార్థ నమూనాలను విశ్లేషించడంలో మాకు సహాయపడతాయి. సేకరించిన అంతర్దృష్టులు కంటెంట్‌ను ఆప్టిమైజ్ చేయడానికి, వినియోగాన్ని మెరుగుపరచడానికి మరియు మొత్తం సైట్ పనితీరును మెరుగుపరచడానికి మాకు అనుమతిస్తాయి."
        },
        "Others": {
          "description": "ఈ వర్గంలో ముందే నిర్వచించిన వర్గాలకు సరిపోని కుక్కీలు ఉన్నాయి కానీ కొన్ని వెబ్‌సైట్ కార్యాచరణలు లేదా మెరుగుదలలకు అవసరం కావచ్చు."
        }
      },
      "service": {
        "disableAll": {
    ...
    "ur": {
      ...
      "purposes": {
        "Analytics": {
          "description": "یہ کوکیز ویب سائٹ ٹریفک، صارف کے رویے، اور مشغولیت کے نمونوں کا تجزیہ کرنے میں ہماری مدد کرتی ہیں۔ جمع کی گئی بصیرتیں ہمیں مواد کو بہتر بنانے، استعمال کو بڑھانے اور سائٹ کی مجموعی کارکردگی کو بہتر بنانے کی اجازت دیتی ہیں۔"
        },
        "Others": {
          "description": "اس زمرے میں ایسی کوکیز شامل ہیں جو پہلے سے طے شدہ زمروں میں فٹ نہیں ہوتی ہیں لیکن ویب سائٹ کی کچھ خصوصیات یا بہتری کے لیے ضروری ہو سکتی ہیں۔"
        }
      },
      "service": {
        "disableAll": {
