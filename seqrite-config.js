...
window.klaroConfig = {
  ...
  "uuid": "ca9a5b88-cd8d-4474-8617-459e278e8d71",
  ...
  "translations": {
    "english": {
      ...
      "save": "Accept",
      "consentModal": {
        "title": "<p>Customize Consent Preferences - For Demo Purpose</p>",
    ...
    "ks": {
      ...
      "save": "قبول کرن۔",
      "consentModal": {
        "title": "ڈیمو مقصد خٲطرٕ کٔرو رضامندی ہنٛز ترجیحات کسٹمائز۔",
    ...
    "doi": {
      ...
      "save": "मंजूर करो",
      "consentModal": {
        "title": "डेमो उद्देश आस्तै सहमति वरीयताएं गी अनुकूलित करो",
    ...
    "ml": {
      ...
      "save": "സ്വീകരിക്കുക",
      "consentModal": {
        "title": "ഡെമോ ഉദ്ദേശ്യത്തിനായി സമ്മത മുൻഗണനകൾ ഇഷ്ടാനുസൃതമാക്കുക",
    ...
    "mni": {
      ...
      "save": "ꯂꯧꯁꯤꯟꯕꯤꯌꯨ",
      "consentModal": {
        "title": "ꯗꯤꯃꯣ ꯄꯔꯁꯒꯤꯗꯃꯛ-ꯀꯟꯁꯦꯟꯠ ꯄ ꯭ ꯔꯦꯐꯔꯦꯟꯁꯁꯤꯡ ꯀꯁ ꯭ ꯇꯥꯃꯥꯏꯖ ꯇꯧ ꯫",
    ...
    "sat": {
      ...
      "save": "ᱦᱟᱛᱟᱣ ᱢᱮ ᱾",
      "consentModal": {
        "title": "ᱫᱮᱢᱳ ᱯᱟᱱᱛᱷᱟ ᱞᱟᱹᱜᱤᱫ ᱥᱟᱫᱮᱥ ᱨᱮᱭᱟᱜ ᱵᱟᱪᱷᱱᱟᱣ ᱠᱚ ᱜᱚᱴᱟᱼᱵᱩᱴᱟᱹ ᱢᱮ ᱾",
    ...
    "ur": {
      ...
      "save": "قبول کریں۔",
      "consentModal": {
        "title": "ڈیمو مقصد کے لیے رضامندی کی ترجیحات کو اپنی مرضی کے مطابق بنائیں",
    ...
    "brx": {
      ...
      "save": "नाजाव",
      "consentModal": {
        "title": "गनायथि सायख 'नायफोरखौ कास्टमाइज खालाम-डेम' थांखिनि थाखाय",
    ...
    "mr": {
      ...
      "save": "स्वीकारा",
      "consentModal": {
        "title": "डेमो उद्देशासाठी संमतीची प्राधान्ये सानुकूलित करा",
    ...
    "or": {
      ...
      "save": "ଗ୍ରହଣ କରନ୍ତୁ",
      "consentModal": {
        "title": "ଡେମୋ ଉଦ୍ଦେଶ୍ୟ ପାଇଁ ସମ୍ମତି ପସନ୍ଦକୁ ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ",
    ...
    "as": {
      ...
      "save": "গ্ৰহণ কৰক",
      "consentModal": {
        "title": "<p>ডেমো উদ্দেশ্যৰ বাবে সন্মতিৰ অগ্ৰাধিকাৰসমূহ অনুকূলিত কৰক</p>",
    ...
    "mai": {
      ...
      "save": "स्वीकार करू",
      "consentModal": {
        "title": "डेमो उद्देश्यक लेल सहमति प्राथमिकता केँ अनुकूलित करू",
    ...
    "ta": {
      ...
      "save": "ஏற்றுக்கொள்",
      "consentModal": {
        "title": "ஒப்புதலுக்கான விருப்பங்களைத் தனிப்பயனாக்குங்கள்-டெமோ நோக்கத்திற்காக",
    ...
    "sd": {
      ...
      "save": "قبول ڪریو",
      "consentModal": {
        "title": "رضامندی جی ترجیحن کی ترتیب ڏیو-ڊیمو مقصد لاء",
    ...
    "bn": {
      ...
      "ok": "সব গ্রহণ করুন",
      "consentNotice": {
        "description": "<p>আমরা আপনার গোপনীয়তাকে সম্মান করি-স্টার হেলথ ডেমো উদ্দেশ্যের জন্য আমরা প্রয়োজনীয় সাইট কার্যকারিতা, পাশাপাশি বিপণন, ব্যক্তিগতকরণ এবং বিশ্লেষণ সক্ষম করতে কুকিজ সঞ্চয় করি। \"সবাইকে গ্রহণ করুন\"-এ ক্লিক করে, আপনি আমাদের কুকি ব্যবহারের জন্য সম্মত হন। আপনি যে কোনও সময় আপনার সেটিংস পরিবর্তন করতে পারেন। কুকি নীতি।</p>",
        "learnMore": "কাস্টমাইজ করুন",
        "changeDescription": " "
      },
      "save": "গ্রহণ করুন",
      "consentModal": {
        "title": "<p>ডেমো উদ্দেশ্যের জন্য সম্মতি পছন্দগুলি কাস্টমাইজ করুন</p>",
    ...
    "te": {
      ...
      "save": "అంగీకరించండి",
      "consentModal": {
        "title": "డెమో పర్పస్ కోసం సమ్మతి ప్రాధాన్యతలను అనుకూలీకరించండి",
    ...
    "gu": {
      ...
      "save": "સ્વીકારો",
      "consentModal": {
        "title": "ડેમો હેતુ માટે-સંમતિ પસંદગીઓને કસ્ટમાઇઝ કરો",
    ...
    "kn": {
      ...
      "save": "ಸ್ವೀಕರಿಸಿ",
      "consentModal": {
        "title": "ಡೆಮೊ ಉದ್ದೇಶಕ್ಕಾಗಿ ಒಪ್ಪಿಗೆಯ ಆದ್ಯತೆಗಳನ್ನು ಕಸ್ಟಮೈಸ್ ಮಾಡಿ",
    ...
    "ne": {
      ...
      "consentModal": {
        "title": "डेमो उद्देश्यका लागि सहमति प्राथमिकताहरू अनुकूलित गर्नुहोस्",
    ...
    "hi": {
      ...
      "save": "स्वीकार करें",
      "consentModal": {
        "title": "डेमो उद्देश्य के लिए सहमति वरीयताओं को अनुकूलित करें",
    ...
    "gom": {
      ...
      "save": "स्विकार कर",
      "consentModal": {
        "title": "डेमो पर्पजा खातीर संमतीची पसंती सानुकूल करात",
    ...
    "pa": {
      ...
      "save": "ਸਵੀਕਾਰ ਕਰੋ",
      "consentModal": {
        "title": "ਡੈਮੋ ਉਦੇਸ਼ ਲਈ ਸਹਿਮਤੀ ਤਰਜੀਹਾਂ ਨੂੰ ਅਨੁਕੂਲਿਤ ਕਰੋ",
    ...
    "sa": {
      ...
      "save": "स्वीकरोतु",
      "consentModal": {
        "title": "डेमो-पर्पस्-कृते सहमति-प्राथमिकतां स्व्यकरोतु",
      ...
      "purposes": {
        "Others": {
          "description": "अस्मिन् वर्गे कुकीस् इत्येतानि अन्तर्भवन्ति यानि पूर्वनिर्धारितेषु वर्गेषु न योजयन्ति परन्तु कतिपय-जालपुट-क्रियात्मकतायै वा सुधाराय वा आवश्यकानि भवेयुः।"
        },
        "Functional": {
